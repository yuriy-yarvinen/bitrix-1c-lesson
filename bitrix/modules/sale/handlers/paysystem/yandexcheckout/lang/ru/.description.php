...
$MESS["SALE_HPS_YANDEX_CHECKOUT_SBER_LOAN"] = "Покупки в кредит";
$MESS["SALE_HPS_YANDEX_CHECKOUT_SBER_LOAN_DESCRIPTION"] = "Клиенты могут оплатить покупку в кредит или рассрочку от СберБанка через Юkassa. При выборе этого способа оплаты покупатель перенаправляется в СберБанк Онлайн для заполнения заявки. После её одобрения СберБанк перечисляет деньги через Юkassa и возвращает пользователя на ваш сайт.";
$MESS["SALE_HPS_YANDEX_CHECKOUT_SBER_LOAN_PUBLIC_DESCRIPTION"] = "Покупайте в кредит или рассрочку от СберБанка за пару минут без визита в банк";
