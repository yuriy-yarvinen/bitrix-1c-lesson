...
$MESS["SALE_VK_SETTINGS_NOTE"] = "Для получения кодов необходимо <a target=\"_blank\" href=\"https://id.vk.ru/about/business/go\">зарегистрировать приложение</a> ВКонтакте (для платформы Web).<br />В поле \"Доверенный redirect URL\" можно указать значение <a href=\"#URL#\">#URL#</a>";
