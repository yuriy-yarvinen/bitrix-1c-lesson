...
$MESS["REGION_REFERENCE_NAME"] = "Подсказка в поле с местоположением";
$MESS["REGION_REFERENCE_PLACEHOLDER"] = "Выберите свой город в списке. Если не получилось, выберите Другое местоположение и напишите название города в соответствующем поле";
