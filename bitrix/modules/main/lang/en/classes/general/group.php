<?php
$MESS["BAD_GROUP_NAME"] = "Please enter the group name.";
$MESS["MAIN_ERROR_STRING_ID"] = "Group with such string ID already exists";
$MESS["MAIN_GROUP_INCORRECT_TIMESTAMP"] = "Incorrect update date.";
