...
final class DisablePrefilters implements FilterAttributeInterface
{
	public function __construct(
		private readonly array $disablePrefilters,
	)
	{
	}
	...
	{
		return $this->disablePrefilters;
	}

	public function getType(): FilterType
	{
		return FilterType::DisablePrefilter;
	}
}