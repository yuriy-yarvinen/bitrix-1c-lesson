...
final class EnablePostfilters implements FilterAttributeInterface
{
	public function __construct(
		private readonly array $enablePostfilters,
	)
	{
	}
	...
	{
		return $this->enablePostfilters;
	}

	public function getType(): FilterType
	{
		return FilterType::EnablePostfilter;
	}
}