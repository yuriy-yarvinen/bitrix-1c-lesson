<?php
$MESS["REST_MARKETPLACE_NOTIFICATION_REST_BUY_MESS_MSGVER_2"] = 'С 1 января приложения Битрикс24 Маркет и REST будут доступны только на коммерческих тарифах. Подберите нужный тариф заранее со скидкой до 40%. #BTN#';
...
$MESS["REST_MARKETPLACE_NOTIFICATION_SUBSCRIPTION_MARKET_TARIFF_MARKET_MESS_MSGVER_2"] = 'Деморежим подписки закончился. Чтобы продолжать пользоваться установленными и другими приложениями, перейдите на расширенный тариф с подпиской.';
...
$MESS["REST_MARKETPLACE_NOTIFICATION_SUBSCRIPTION_MARKET_TRIAL_END_MESS_MSGVER_2"] = 'Деморежим подписки закончился. Оформите подписку, чтобы продолжить пользоваться всеми приложениями.';
