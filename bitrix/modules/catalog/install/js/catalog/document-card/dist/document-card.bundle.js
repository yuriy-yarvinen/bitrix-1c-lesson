...
(function (exports,catalog_entityCard,catalog_storeEnableWizard,main_popup,ui_buttons,ui_label,currency_currencyCore,ui_entitySelector,main_core_events,ui_feedback_form,main_core) {
	...
	var Slider = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(Slider, null, [{
	    ...
	    value: function () {
	      var _openIntegrationRequestForm = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
	        ...
	        return _regeneratorRuntime().wrap(function _callee$(_context) {
	          while (1) switch (_context.prev = _context.next) {
	            case 0:
	              ...
	              _context.prev = 1;
	              _context.next = 4;
	              return main_core.ajax.runComponentAction('bitrix:catalog.feedback', 'getFormParams', {
	                mode: 'class'
	              });
	            case 4:
	      ...
	      function openIntegrationRequestForm(_x) {
	        return _openIntegrationRequestForm.apply(this, arguments);
	      }
	      return openIntegrationRequestForm;
	    }()
	  }, {
	    key: "open",
