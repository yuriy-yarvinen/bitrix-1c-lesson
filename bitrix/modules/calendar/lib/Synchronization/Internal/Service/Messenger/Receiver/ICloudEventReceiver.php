...
use Bitrix\Calendar\Synchronization\Public\Command\Event\ICloud\CreateEventCommand;
use Bitrix\Calendar\Synchronization\Public\Command\Event\ICloud\DeleteEventCommand;
use Bitrix\Calendar\Synchronization\Public\Command\Event\ICloud\ExcludeEventDateCommand;
use Bitrix\Calendar\Synchronization\Public\Command\Event\ICloud\UpdateEventCommand;
...
class ICloudEventReceiver extends AbstractEventReceiver
{
	/**
	...
	protected function buildCommand(EventMessage $message): ?CommandInterface
	{
		...
		{
			return new ExcludeEventDateCommand($event);
		}
