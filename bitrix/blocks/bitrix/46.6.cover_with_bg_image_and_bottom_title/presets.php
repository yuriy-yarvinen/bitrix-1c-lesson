...
$youtubeVideo = [
	...
	'preview' => '//img.youtube.com/vi/q4d8g9Dn3ww/sddefault.jpg',
];
$videoSrc = $isRuZone ? '' : $youtubeVideo['src'];
$videoSource = $isRuZone ? '' : $youtubeVideo['source'];
$videoPreview = $isRuZone ? '' : $youtubeVideo['preview'];
...
return [
	...
	'video' => [
		...
		'values' => [
			...
			'.landing-block-node-card-videobg' => $videoSrc,
		],
	],
];