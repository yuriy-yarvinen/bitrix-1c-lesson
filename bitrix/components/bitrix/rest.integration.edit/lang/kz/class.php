...
$MESS["REST_INTEGRATION_EDIT_ERROR_NO_HTTPS"] = "<strong>Назар аударыңыз!</strong> Бұл технологияны https-сіз пайдалануға болмайды";
$MESS["REST_INTEGRATION_EDIT_ERROR_REQUIRED_MODULES"] = "Бұл интеграция үшін модульді орнату қажет: #MODULE_CODE#";
$MESS["REST_INTEGRATION_EDIT_HOLD_DUE_TO_OVERLOAD"] = "<strong>Назар аударыңыз!</strong> Бұл интеграция жүктемеден асып кеткені үшін бұғатталған. Өтініш, бұл мәселені шешу үшін қолдау бөліміне жүгініңіз.";
