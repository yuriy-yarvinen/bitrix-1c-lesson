...
(function (exports,ui_qrauthorization,main_core) {
	...
	var AppsCollaboration = /*#__PURE__*/function (_BX$Landing$Widget$Ba) {
	  babelHelpers.inherits(AppsCollaboration, _BX$Landing$Widget$Ba);
	  function AppsCollaboration(element, options) {
	    var _this;
	    babelHelpers.classCallCheck(this, AppsCollaboration);
	    _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(AppsCollaboration).call(this, element));
	    _this.initialize(element, options);
	    return _this;
	  }
	  babelHelpers.createClass(AppsCollaboration, [{
	    key: "initialize",
	  ...
	  return AppsCollaboration;
	}(BX.Landing.Widget.Base);

	exports.AppsCollaboration = AppsCollaboration;
