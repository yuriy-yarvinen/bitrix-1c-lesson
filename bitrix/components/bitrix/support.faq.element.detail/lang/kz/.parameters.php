<?php
$MESS["CP_BSFED_CACHE_GROUPS"] = "Қолжетімділік құқықтарын ескеру";
...
$MESS["SUPPORT_FAQ_ED_GROUP_SETTINGS"] = "Компонент баптаулары";
$MESS["SUPPORT_FAQ_ED_SETTING_ELEMENTS_LIST"] = "Элементтің ID-і";
$MESS["SUPPORT_FAQ_ED_SETTING_IBLIST"] = "Ақпараттық блок тізімдері";
$MESS["SUPPORT_FAQ_ED_SETTING_IBTYPES"] = "Ақпараттық блок түрлері";
$MESS["SUPPORT_FAQ_ED_SETTING_SECTIONS_LIST"] = "Секцияның ID-і";
