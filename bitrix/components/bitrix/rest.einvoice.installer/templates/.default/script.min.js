this.BX=this.BX||{};(function(e,s,t,a,i,l,r,o){"use strict";let n=e=>e,b;class c extends l.EventEmitter{constructor(){super();this.setEventNamespace("BX.Rest.EInvoiceInstaller.Page")}getContent(){throw new Error("Must be implemented in a child class")}getIcon(){return t.Tag.render(b||(b=n`
		...
		`))}static getType(){throw new Error("Must be implemented in a child class")}}let v=e=>e,p;var d=babelHelpers.classPrivateFieldLooseKey("content");var P=babelHelpers.classPrivateFieldLooseKey("button");var h=babelHelpers.classPrivateFieldLooseKey("getButton");class u extends c{constructor(){super();Object.defineProperty(this,h,{value:L});Object.defineProperty(this,d,{writable:true,value:void 0});Object.defineProperty(this,P,{writable:true,value:void 0});this.setEventNamespace("BX.Rest.EInvoiceInstaller.ErrorPage")}static getType(){return"error"}getContent(){if(!babelHelpers.classPrivateFieldLooseBase(this,d)[d]){babelHelpers.classPrivateFieldLooseBase(this,d)[d]=t.Tag.render(p||(p=v`
