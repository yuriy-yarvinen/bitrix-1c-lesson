this.BX=this.BX||{};this.BX.UI=this.BX.UI||{};(function(e,t,s,i,r,a,o,l,n,d,c,h,b,u,p,g,v,f,P,m,L,y,F){"use strict";const H=L.createCommand("HIDE_DIALOG_COMMAND");const B=L.createCommand("DIALOG_VISIBILITY_COMMAND");const C=L.createCommand("DRAG_START_COMMAND");const O=L.createCommand("DRAG_END_COMMAND");var T=Object.freeze({HIDE_DIALOG_COMMAND:H,DIALOG_VISIBILITY_COMMAND:B,DRAG_START_COMMAND:C,DRAG_END_COMMAND:O});const E=1;const N={LINE_BREAK:"line-break",PARAGRAPH:"paragraph",MIXED:"mixed"};var _=Object.freeze({UNFORMATTED:E,NewLineMode:N});const M=Object.freeze({"\t":"\\t","\n":"\\n"});const D=new RegExp(Object.keys(M).join("|"),"g");const S=Object.freeze({ancestorHasNextSibling:"|",ancestorIsLastChild:" ",hasNextSibling:"\u251c",isLastChild:"\u2514",selectedChar:"^",selectedLine:">"});const R=[e=>e.hasFormat("bold")&&"Bold",e=>e.hasFormat("code")&&"Code",e=>e.hasFormat("italic")&&"Italic",e=>e.hasFormat("strikethrough")&&"Strikethrough",e=>e.hasFormat("subscript")&&"Subscript",e=>e.hasFormat("superscript")&&"Superscript",e=>e.hasFormat("underline")&&"Underline"];const I=[e=>e.isDirectionless()&&"Directionless",e=>e.isUnmergeable()&&"Unmergeable"];const x=[e=>e.isToken()&&"Token",e=>e.isSegmented()&&"Segmented"];function w(e){const t=e.anchor;const s=e.focus;const i=e.anchor.getNode();const r=e.focus.getNode();if(i===r){return i}const a=e.isBackward();if(a){return d.$isAtNodeEnd(s)?i:r}return d.$isAtNodeEnd(t)?i:r}const A={b:"bold",strong:"bold",i:"italic",em:"italic",s:"strikethrough",del:"strikethrough",u:"underline",sub:"subscript",sup:"superscript"};function $(e){const t=A[e.getName()];if(t===undefined){return{node:null}}return{forChild:e=>{if(L.$isTextNode(e)&&!e.hasFormat(t)){e.toggleFormat(t)}return e},node:null}}function K(e,t,i=true){const r=t.getBBCodeScheme();const a=new s.BBCodeParser({scheme:r});const o=a.parse(e);const l=o.getChildren();let n=[];for(const e of l){const s=j(e,t);if(s!==null){n=[...n,...s]}}return i?U(n):n}function j(e,t,s=new Map,i=null){if(e instanceof n.BBCodeNewLineNode){return[L.$createLineBreakNode()]}if(e instanceof n.BBCodeTabNode){return[L.$createTabNode()]}let r=[];let a=null;const o=Y(e,t);const l=o?o(e):null;let d=null;if(l!==null){d=l.after;const t=l.node;a=Array.isArray(t)?t[t.length-1]:t;if(a!==null){for(const[,e]of s){a=e(a,i);if(!a){break}}if(a){r.push(...Array.isArray(t)?t:[a])}}if(F.Type.isFunction(l.forChild)){s.set(e.getName(),l.forChild)}}const c=e.getChildren();let h=[];for(const e of c){h.push(...j(e,t,new Map(s),a))}if(F.Type.isFunction(d)){h=d(h)}if(l===null){if(e.getType()===n.BBCodeNode.ELEMENT_NODE){const t=e;if(t.isVoid()){h=[L.$createTextNode(t.getOpeningTag()),...h]}else{h=[L.$createTextNode(t.getOpeningTag()),...h,L.$createTextNode(t.getClosingTag())]}}else{h=[L.$createTextNode(e.toString()),...h]}}if(a===null){r=[...r,...h]}else if(L.$isElementNode(a)){a.append(...h)}return r}function k(e){if(L.$isElementNode(e)&&e.isInline()===false){return false}return!(L.$isDecoratorNode(e)&&e.isInline()===false)}function U(e){const t=[];let s=null;let i=0;for(const r of e){if(L.$isLineBreakNode(r)){i++;continue}if(k(r)){if(s===null||i>=2){t.push(...W(i-2));s=L.$createParagraphNode();t.push(s)}else if(i===1){s.append(L.$createLineBreakNode())}s.append(r)}else{if(i>2){t.push(...W(i-2))}t.push(r);s=null}i=0}if(t.length===0){return[L.$createParagraphNode()]}return t}function W(e=1){const t=[];for(let s=0;s<e;s++){t.push(L.$createParagraphNode())}return t}function Y(e,t){const s=e.getName();let i=null;const r=t.getBBCodeImportMap();const a=r.get(s.toLowerCase());if(a!==undefined){for(const t of a){const s=t(e);if(s!==null&&(i===null||i.priority<s.priority)){i=s}}}if(i===null){if(s==="#text"){return z}return null}return i.conversion}function z(e){let t=e.getContent();t=t.replaceAll(/\r?\n|\t/gm," ").replace("\r","");if(t===""){return{node:null}}return{node:L.$createTextNode(t)}}function X(e){if(!L.$isParagraphNode(e)){return false}if(e.isEmpty()){return true}return e.getChildren().every((e=>L.$isLineBreakNode(e)||L.$isTextNode(e)&&/^\s*$/.test(e.getTextContent())))}function G(e){const t=[...e];while(t.length>0&&X(t[0])){t.splice(0,1)}while(t.length>0&&X(t[t.length-1])){t.splice(-1,1)}return t}function V(e,t){const s=t.getBBCodeScheme();const i=s.createRoot();const r=G(e.getChildren());for(const e of r){J(e,i,t)}return i}function J(e,t,s){const{node:i,after:r}=Q(e,s);if(!i){return}const a=s.getBBCodeScheme();const o=a.createFragment();const l=L.$isElementNode(e)?e.getChildren():[];for(const e of l){J(e,o,s)}i.appendChild(o);t.appendChild(i);if(F.Type.isFunction(r)){const t=r.call(e,i);if(t){i.getParent().replaceChild(i,t)}}}const q=["bold","italic","strikethrough","underline"];function Q(e,t){const s=e.getType();const i=t.getBBCodeExportMap();const r=i.get(s);if(F.Type.isFunction(r)){return r(e)}const a=t.getBBCodeScheme();if(L.$isTextNode(e)&&e.getType()==="text"){const t=a.createText({encode:false,content:e.getTextContent()});if(e.getFormat()===0){return{node:t}}let s=t;q.forEach((t=>{const r=i.get(`text:${t}`);if(F.Type.isFunction(r)){s=r(e,s)||s}}));return{node:s}}if(L.$isLineBreakNode(e)){return{node:a.createNewLine()}}if(L.$isTabNode(e)){return{node:a.createTab()}}if(L.$isTextNode(e)||L.$isElementNode(e)){const t=a.createText({encode:false,content:e.getTextContent()});return{node:t}}return{node:null}}function Z(e,t,s){const i=s.getBBCodeScheme();const r=i.createElement({name:t});r.appendChild(e);return r}var ee=babelHelpers.classPrivateFieldLooseKey("textEditor");var te=babelHelpers.classPrivateFieldLooseKey("destroyed");var se=babelHelpers.classPrivateFieldLooseKey("removeListeners");class ie{constructor(e){Object.defineProperty(this,ee,{writable:true,value:null});Object.defineProperty(this,te,{writable:true,value:false});Object.defineProperty(this,se,{writable:true,value:()=>{}});babelHelpers.classPrivateFieldLooseBase(this,ee)[ee]=e}static getName(){throw new Error("getName must be implemented in a child class")}static getNodes(e){return[]}importBBCode(){return null}exportBBCode(){return null}validateScheme(){return null}afterInit(){}getName(){return this.constructor.getName()}getEditor(){return babelHelpers.classPrivateFieldLooseBase(this,ee)[ee]}getLexicalEditor(){return babelHelpers.classPrivateFieldLooseBase(this,ee)[ee].getLexicalEditor()}cleanUpRegister(...e){babelHelpers.classPrivateFieldLooseBase(this,se)[se]=y.mergeRegister(babelHelpers.classPrivateFieldLooseBase(this,se)[se],...e)}isDestroyed(){return babelHelpers.classPrivateFieldLooseBase(this,te)[te]}destroy(){babelHelpers.classPrivateFieldLooseBase(this,te)[te]=true;babelHelpers.classPrivateFieldLooseBase(this,se)[se]();babelHelpers.classPrivateFieldLooseBase(this,se)[se]=null}}class re extends b.EventEmitter{constructor(){super();this.setEventNamespace("BX.UI.TextEditor.ToolbarItem")}getContainer(){throw new Error("You must implement getContainer() method.")}render(){throw new Error("You must implement render() method.")}}let ae=e=>e,oe;var le=babelHelpers.classPrivateFieldLooseKey("format");var ne=babelHelpers.classPrivateFieldLooseKey("blockType");var de=babelHelpers.classPrivateFieldLooseKey("active");var ce=babelHelpers.classPrivateFieldLooseKey("disabled");var he=babelHelpers.classPrivateFieldLooseKey("disableInsideUnformatted");var be=babelHelpers.classPrivateFieldLooseKey("disableCallback");var ue=babelHelpers.classPrivateFieldLooseKey("container");var pe=babelHelpers.classPrivateFieldLooseKey("handleClick");class ge extends re{constructor(...e){super(...e);Object.defineProperty(this,pe,{value:ve});Object.defineProperty(this,le,{writable:true,value:null});Object.defineProperty(this,ne,{writable:true,value:null});Object.defineProperty(this,de,{writable:true,value:false});Object.defineProperty(this,ce,{writable:true,value:false});Object.defineProperty(this,he,{writable:true,value:false});Object.defineProperty(this,be,{writable:true,value:null});Object.defineProperty(this,ue,{writable:true,value:null})}setContent(e){if(F.Type.isString(e)){this.getContainer().innerHTML=e}else if(F.Type.isElementNode(e)){this.getContainer().append(e)}}setFormat(e){babelHelpers.classPrivateFieldLooseBase(this,le)[le]=e}getFormat(){return babelHelpers.classPrivateFieldLooseBase(this,le)[le]}hasFormat(){return babelHelpers.classPrivateFieldLooseBase(this,le)[le]}setBlockType(e){babelHelpers.classPrivateFieldLooseBase(this,ne)[ne]=e}getBlockType(){return babelHelpers.classPrivateFieldLooseBase(this,ne)[ne]}setTooltip(e){if(F.Type.isStringFilled(e)){F.Dom.attr(this.getContainer(),"title",F.Text.encode(e))}else if(e===null){F.Dom.attr(this.getContainer(),"title",null)}}disableInsideUnformatted(){babelHelpers.classPrivateFieldLooseBase(this,he)[he]=true}enableInsideUnformatted(){babelHelpers.classPrivateFieldLooseBase(this,he)[he]=false}shouldDisableInsideUnformatted(){return babelHelpers.classPrivateFieldLooseBase(this,he)[he]}setActive(e=true){if(e===babelHelpers.classPrivateFieldLooseBase(this,de)[de]){return}babelHelpers.classPrivateFieldLooseBase(this,de)[de]=e;if(e){F.Dom.addClass(this.getContainer(),"--active")}else{F.Dom.removeClass(this.getContainer(),"--active")}}isActive(){return babelHelpers.classPrivateFieldLooseBase(this,de)[de]}setDisabled(e=true){if(e===babelHelpers.classPrivateFieldLooseBase(this,ce)[ce]){return}babelHelpers.classPrivateFieldLooseBase(this,ce)[ce]=e;if(e){F.Dom.attr(this.getContainer(),{disabled:true})}else{F.Dom.attr(this.getContainer(),{disabled:null})}}disable(){this.setDisabled(true)}enable(){this.setDisabled(false)}isDisabled(){return babelHelpers.classPrivateFieldLooseBase(this,ce)[ce]}hasOwnDisableCallback(){return babelHelpers.classPrivateFieldLooseBase(this,be)[be]!==null}setDisableCallback(e){if(F.Type.isFunction(e)){babelHelpers.classPrivateFieldLooseBase(this,be)[be]=e}}invokeDisableCallback(){return babelHelpers.classPrivateFieldLooseBase(this,be)[be]()}getContainer(){if(babelHelpers.classPrivateFieldLooseBase(this,ue)[ue]===null){babelHelpers.classPrivateFieldLooseBase(this,ue)[ue]=F.Tag.render(oe||(oe=ae`
			...
			`))))}}function zd(){const e=this.getLinkTextBox().value.trim();if(e.length>0){this.setLinkUrl(e);this.emit("onSave")}else{this.getLinkTextBox().focus()}}function Xd(e){if(e.key==="Enter"){e.preventDefault();babelHelpers.classPrivateFieldLooseBase(this,Kd)[Kd]()}}function Gd(){this.emit("onCancel")}function Vd(){this.setEditMode(true);this.getLinkTextBox().focus();this.getLinkTextBox().select()}function Jd(){this.emit("onUnlink")}class qd extends P.LinkNode{constructor(e="",t={},s=null){super(e,t,s)}static getType(){return"custom-link"}static clone(e){return new qd(e.__url,{rel:e.__rel,target:e.__target,title:e.__title},e.__key)}static importJSON(e){return super.importJSON(e)}exportJSON(){return{...super.exportJSON(),type:"custom-link",version:1}}createDOM(e){const t=super.createDOM(e);t.setAttribute("data-slider-ignore-autobinding","true");return t}}function Qd(e="",t={}){return L.$applyNodeReplacement(new qd(e,t))}function Zd(e,t=true){if(t){return/^(http:|https:|mailto:|tel:|sms:|\/)/i.test(e)}return/^(http:|https:|mailto:|tel:|sms:)/i.test(e)}const ec=L.createCommand("INSERT_LINK_DIALOG_COMMAND");var tc=babelHelpers.classPrivateFieldLooseKey("linkEditor");var sc=babelHelpers.classPrivateFieldLooseKey("onEditorScroll");var ic=babelHelpers.classPrivateFieldLooseKey("lastSelection");var rc=babelHelpers.classPrivateFieldLooseKey("registerListeners");var ac=babelHelpers.classPrivateFieldLooseKey("registerCommands");var oc=babelHelpers.classPrivateFieldLooseKey("registerToggleLinkCommand");var lc=babelHelpers.classPrivateFieldLooseKey("registerInsertLinkCommand");var nc=babelHelpers.classPrivateFieldLooseKey("restoreSelection");var dc=babelHelpers.classPrivateFieldLooseKey("handleDialogDestroy");var cc=babelHelpers.classPrivateFieldLooseKey("handleEditorScroll");var hc=babelHelpers.classPrivateFieldLooseKey("registerKeyModifierCommand");var bc=babelHelpers.classPrivateFieldLooseKey("registerPasteCommand");var uc=babelHelpers.classPrivateFieldLooseKey("insertLink");var pc=babelHelpers.classPrivateFieldLooseKey("isLinkSelected");var gc=babelHelpers.classPrivateFieldLooseKey("convertAutoLinkToLink");var vc=babelHelpers.classPrivateFieldLooseKey("registerComponents");class fc extends ie{constructor(e){super(e);Object.defineProperty(this,vc,{value:_c});Object.defineProperty(this,gc,{value:Nc});Object.defineProperty(this,pc,{value:Ec});Object.defineProperty(this,uc,{value:Tc});Object.defineProperty(this,bc,{value:Oc});Object.defineProperty(this,hc,{value:Cc});Object.defineProperty(this,cc,{value:Bc});Object.defineProperty(this,dc,{value:Hc});Object.defineProperty(this,nc,{value:Fc});Object.defineProperty(this,lc,{value:yc});Object.defineProperty(this,oc,{value:Lc});Object.defineProperty(this,ac,{value:mc});Object.defineProperty(this,rc,{value:Pc});Object.defineProperty(this,tc,{writable:true,value:null});Object.defineProperty(this,sc,{writable:true,value:babelHelpers.classPrivateFieldLooseBase(this,cc)[cc].bind(this)});Object.defineProperty(this,ic,{writable:true,value:null});babelHelpers.classPrivateFieldLooseBase(this,ac)[ac]();babelHelpers.classPrivateFieldLooseBase(this,rc)[rc]();babelHelpers.classPrivateFieldLooseBase(this,vc)[vc]()}static getName(){return"Link"}static getNodes(e){return[P.LinkNode,qd,{replace:P.LinkNode,with:e=>Qd(e.__url,{rel:e.__rel,target:e.__target,title:e.__title}),withClass:qd}]}importBBCode(){return{url:()=>({conversion:e=>{let t=e.getValue();if(!Zd(t)){t=e.toPlainText();if(!Zd(t)){return{node:null}}}return{node:P.$createLinkNode(aa(t),{target:"_blank"})}},priority:0})}}exportBBCode(){return{link:e=>Mc(e,this.getEditor()),"custom-link":e=>Mc(e,this.getEditor())}}validateScheme(){return{nodes:[{nodeClass:qd}],bbcodeMap:{link:"url","custom-link":"url"}}}destroy(){super.destroy();if(babelHelpers.classPrivateFieldLooseBase(this,tc)[tc]!==null){babelHelpers.classPrivateFieldLooseBase(this,tc)[tc].destroy()}}}function Pc(){this.cleanUpRegister(this.getEditor().registerEventListener(P.LinkNode,"click",((e,t)=>{const s=L.$getNodeByKey(t);if(P.$isLinkNode(s)){this.getEditor().dispatchCommand(ec,s)}})))}function mc(){this.cleanUpRegister(babelHelpers.classPrivateFieldLooseBase(this,oc)[oc](),babelHelpers.classPrivateFieldLooseBase(this,lc)[lc](),babelHelpers.classPrivateFieldLooseBase(this,hc)[hc](),babelHelpers.classPrivateFieldLooseBase(this,bc)[bc]())}function Lc(){return this.getEditor().registerCommand(P.TOGGLE_LINK_COMMAND,(e=>{if(e===null){P.$toggleLink(e);return true}const t=L.$getSelection();if(!L.$isRangeSelection(t)){return false}let s=null;let i=null;let r={};if(F.Type.isStringFilled(e)){s=e}else if(F.Type.isPlainObject(e)){const{target:t,rel:a,title:o}=e;r={rel:a,target:t,title:o};s=e.url;i=e.originalUrl||null}if(F.Type.isStringFilled(s)){if(!F.Type.isStringFilled(r.target)){r.target="_blank"}if(Zd(s)){if(t.isCollapsed()&&!babelHelpers.classPrivateFieldLooseBase(this,pc)[pc](t)){babelHelpers.classPrivateFieldLooseBase(this,uc)[uc](t,s,r,i)}else{P.$toggleLink(s,r)}return true}return false}return false}),L.COMMAND_PRIORITY_LOW)}function yc(){return y.mergeRegister(this.getEditor().registerCommand(ec,(e=>{const t=L.$getSelection();if(!L.$isRangeSelection(t)||!this.getEditor().isEditable()){return false}babelHelpers.classPrivateFieldLooseBase(this,ic)[ic]=t.clone();if(babelHelpers.classPrivateFieldLooseBase(this,tc)[tc]!==null){babelHelpers.classPrivateFieldLooseBase(this,tc)[tc].destroy()}let s=null;let i=null;if(P.$isLinkNode(e)){s=e;i=s.getURL()}else{const e=y.$findMatchingParent(t.anchor.getNode(),(e=>(e.__flags&E)!==0));if(e){return false}const r=w(t);const a=y.$findMatchingParent(r,P.$isLinkNode);if(a){s=a;i=s.getURL();s.select()}else if(P.$isLinkNode(r)){s=r;i=s.getURL();s.select()}}this.getEditor().dispatchCommand(H);babelHelpers.classPrivateFieldLooseBase(this,tc)[tc]=new Yd({linkUrl:i,autoLinkMode:P.$isAutoLinkNode(s),targetContainer:document.body,events:{onSave:e=>{const t=e.getTarget();let i=t.getLinkUrl();if(!F.Type.isStringFilled(i)){t.hide();return}const r=F.Validation.isEmail(i)?"mailto:":"https://";const a=i;if(!Zd(i)){i=`${r}${i}`;t.setLinkUrl(i)}if(s===null){this.getEditor().update((()=>{babelHelpers.classPrivateFieldLooseBase(this,nc)[nc]();this.getEditor().dispatchCommand(P.TOGGLE_LINK_COMMAND,{url:i,originalUrl:a,rel:null});t.setEditMode(false);const e=L.$getSelection();if(L.$isRangeSelection(e)){babelHelpers.classPrivateFieldLooseBase(this,ic)[ic]=e.clone()}if(!L.$isRangeSelection(e)||e.isCollapsed()){t.hide()}babelHelpers.classPrivateFieldLooseBase(this,gc)[gc](e)}))}else{this.getEditor().update((()=>{s.setURL(i);babelHelpers.classPrivateFieldLooseBase(this,gc)[gc](L.$getSelection());t.setAutoLinkMode(false)}));t.setEditMode(false)}this.getEditor().resetHighlightSelection()},onCancel:e=>{const t=e.getTarget();t.hide()},onUnlink:e=>{if(s===null){this.getEditor().dispatchCommand(P.TOGGLE_LINK_COMMAND,null)}else{this.getEditor().update((()=>{const e=s.getChildren();for(const t of e){s.insertBefore(t)}s.remove()}))}const t=e.getTarget();t.hide()},onShow:()=>{if(ta(babelHelpers.classPrivateFieldLooseBase(this,tc)[tc].getPopup(),this.getEditor())){F.Event.bind(this.getEditor().getScrollerContainer(),"scroll",babelHelpers.classPrivateFieldLooseBase(this,sc)[sc]);this.getEditor().highlightSelection()}},onClose:()=>{babelHelpers.classPrivateFieldLooseBase(this,dc)[dc]()},onDestroy:()=>{babelHelpers.classPrivateFieldLooseBase(this,dc)[dc]()}}});babelHelpers.classPrivateFieldLooseBase(this,tc)[tc].show();return true}),L.COMMAND_PRIORITY_LOW),this.getEditor().registerCommand(H,(()=>{if(babelHelpers.classPrivateFieldLooseBase(this,tc)[tc]!==null){babelHelpers.classPrivateFieldLooseBase(this,tc)[tc].destroy()}return false}),L.COMMAND_PRIORITY_LOW),this.getEditor().registerCommand(B,(()=>babelHelpers.classPrivateFieldLooseBase(this,tc)[tc]!==null&&babelHelpers.classPrivateFieldLooseBase(this,tc)[tc].isShown()),L.COMMAND_PRIORITY_LOW))}function Fc(){const e=L.$getSelection();if(!L.$isRangeSelection(e)&&babelHelpers.classPrivateFieldLooseBase(this,ic)[ic]!==null){L.$setSelection(babelHelpers.classPrivateFieldLooseBase(this,ic)[ic]);babelHelpers.classPrivateFieldLooseBase(this,ic)[ic]=null;return true}return false}function Hc(){babelHelpers.classPrivateFieldLooseBase(this,tc)[tc]=null;F.Event.unbind(this.getEditor().getScrollerContainer(),"scroll",babelHelpers.classPrivateFieldLooseBase(this,sc)[sc]);this.getEditor().resetHighlightSelection();this.getEditor().update((()=>{if(!babelHelpers.classPrivateFieldLooseBase(this,nc)[nc]()){this.getEditor().focus()}}))}function Bc(){this.getEditor().update((()=>{ta(babelHelpers.classPrivateFieldLooseBase(this,tc)[tc].getPopup(),this.getEditor())}))}function Cc(){return this.getEditor().registerCommand(L.KEY_MODIFIER_COMMAND,(e=>{const t=e;const{code:s,ctrlKey:i,metaKey:r}=t;if(s==="KeyK"&&(i||r)){t.preventDefault();this.getEditor().dispatchCommand(ec);return true}return false}),L.COMMAND_PRIORITY_NORMAL)}function Oc(){return this.getEditor().registerCommand(L.PASTE_COMMAND,(e=>{const t=L.$getSelection();if(!L.$isRangeSelection(t)||!(e instanceof ClipboardEvent)||e.clipboardData===null){return false}const s=e.clipboardData.getData("text");if(!Zd(s,false)){return false}if(t.isCollapsed()){const t=this.getEditor().dispatchCommand(P.TOGGLE_LINK_COMMAND,{url:s});if(t){e.preventDefault();return true}}else if(!t.getNodes().some((e=>L.$isElementNode(e)))){P.$toggleLink(s);e.preventDefault();return true}return false}),L.COMMAND_PRIORITY_NORMAL)}function Tc(e,t,s,i){const r=aa(t);const a=P.$createLinkNode(r,s);a.append(L.$createTextNode(F.Type.isStringFilled(i)?i:r));const o=e.anchor;if(o.type==="text"&&o.getNode().isSimpleText()){const e=o.getNode();const t=o.offset;const s=e.splitText(t);if(t===0){s[0].insertBefore(a);a.select()}else{s[0].insertAfter(a);a.select()}}else{L.$insertNodes([a]);if(L.$isRootOrShadowRoot(a.getParentOrThrow())){y.$wrapNodeInElement(a,L.$createParagraphNode).selectEnd()}}}function Ec(e){const t=w(e);const s=t.getParent();return P.$isLinkNode(s)||P.$isLinkNode(t)}function Nc(e){if(L.$isRangeSelection(e)){const t=w(e).getParent();if(P.$isAutoLinkNode(t)){const e=P.$createLinkNode(t.getURL(),{rel:t.getRel(),target:F.Type.isStringFilled(t.getTarget())?t.getTarget():"_blank",title:t.getTitle()});t.replace(e,true);return true}}return false}function _c(){this.getEditor().getComponentRegistry().register("link",(()=>{const e=new ge;e.setContent('<span class="ui-icon-set --link-3"></span>');e.setTooltip(F.Loc.getMessage("TEXT_EDITOR_BTN_LINK"));e.setBlockType("link");e.disableInsideUnformatted();e.setTooltip(F.Loc.getMessage("TEXT_EDITOR_BTN_LINK",{"#keystroke#":F.Browser.isMac()?"\u2318K":"Ctrl+K"}));e.subscribe("onClick",(()=>{if(babelHelpers.classPrivateFieldLooseBase(this,tc)[tc]!==null&&babelHelpers.classPrivateFieldLooseBase(this,tc)[tc].isShown()){return}this.getEditor().focus((()=>{this.getEditor().dispatchCommand(ec)}))}));return e}))}function Mc(e,t){const s=e.getURL();const i=e.getChildren();const r=i.length===1&&L.$isTextNode(i[0])&&i[0].getFormat()===0;const a=t.getBBCodeScheme();if(r&&i[0].getTextContent()===s){return{node:a.createElement({name:"url"})}}return{node:a.createElement({name:"url",value:s})}}var Dc=Object.freeze({INSERT_LINK_DIALOG_COMMAND:ec,LinkPlugin:fc,exportLinkNode:Mc});class Sc extends P.AutoLinkNode{constructor(e="",t={},s=null){super(e,t,s)}static getType(){return"custom-autolink"}static clone(e){return new Sc(e.__url,{isUnlinked:e.__isUnlinked,rel:e.__rel,target:e.__target,title:e.__title},e.__key)}static importJSON(e){return super.importJSON(e)}exportJSON(){return{...super.exportJSON(),type:"custom-autolink",version:1}}createDOM(e){const t=super.createDOM(e);t.setAttribute("data-slider-ignore-autobinding","true");return t}}function Rc(e="",t={}){return L.$applyNodeReplacement(new Sc(e,t))}const Ic=/((https?:\/\/(www\.)?)|(www\.))[\w#%+.:=@~-]{1,256}\.[\d()A-Za-z]{1,6}\b([\w#%&()+./:=?@[\]~-]*)(?<![%()+.:\]-])/;const xc=/(([^\s"(),.:;<>@[\\\]]+(\.[^\s"(),.:;<>@[\\\]]+)*)|(".+"))@((\[(?:\d{1,3}\.){3}\d{1,3}])|(([\dA-Za-z-]+\.)+[A-Za-z]{2,}))/;const wc=[jc(Ic,(e=>e.startsWith("http")?e:`https://${e}`)),jc(xc,(e=>`mailto:${e}`))];var Ac=babelHelpers.classPrivateFieldLooseKey("registerListeners");class $c extends ie{constructor(e){super(e);Object.defineProperty(this,Ac,{value:Kc});babelHelpers.classPrivateFieldLooseBase(this,Ac)[Ac]()}static getName(){return"AutoLink"}static getNodes(e){return[P.AutoLinkNode,Sc,{replace:P.AutoLinkNode,with:e=>Rc(e.__url,{isUnlinked:e.__isUnlinked,rel:e.__rel,target:e.__target,title:e.__title}),withClass:Sc}]}exportBBCode(){return{autolink:e=>Mc(e,this.getEditor()),"custom-autolink":e=>Mc(e,this.getEditor())}}validateScheme(){return{nodes:[{nodeClass:Sc}],bbcodeMap:{autolink:"url","custom-autolink":"url"}}}}function Kc(){const e=(e,t)=>{};this.cleanUpRegister(this.getEditor().registerNodeTransform(L.TextNode,(t=>{const s=t.getParentOrThrow();const i=t.getPreviousSibling();if(P.$isAutoLinkNode(s)){Qc(s,wc,e)}else if(!P.$isLinkNode(s)){if(t.isSimpleText()&&(zc(t.getTextContent())||!P.$isAutoLinkNode(i))){const s=y.$findMatchingParent(t,(e=>(e.__flags&E)!==0));if(!s){qc(t,wc,e)}}Zc(t,wc,e)}})))}function jc(e,t=e=>e){return s=>{const i=e.exec(s);if(i===null){return null}return{index:i.index,length:i[0].length,text:i[0],url:t(s)}}}function kc(e,t){for(const s of t){const t=s(e);if(t){return t}}return null}const Uc=/[\s(),.;[\]]/;function Wc(e){return Uc.test(e)}function Yc(e){return Wc(e[e.length-1])}function zc(e){return Wc(e[0])}function Xc(e){return/^\.[\dA-Za-z]+/.test(e)}function Gc(e){let t=e.getPreviousSibling();if(L.$isElementNode(t)){t=t.getLastDescendant()}return t===null||L.$isLineBreakNode(t)||L.$isTextNode(t)&&Yc(t.getTextContent())}function Vc(e){let t=e.getNextSibling();if(L.$isElementNode(t)){t=t.getFirstDescendant()}return t===null||L.$isLineBreakNode(t)||L.$isTextNode(t)&&zc(t.getTextContent())}function Jc(e,t,s,i){const r=e>0?Wc(s[e-1]):Gc(i);if(!r){return false}return t<s.length?Wc(s[t]):Vc(i)}function qc(e,t,s){const i=e.getTextContent();let r=i;let a=0;let o=e;let l=kc(r,t);while(l!==null){const n=l.index;const d=l.length;const c=n+d;const h=Jc(a+n,a+c,i,e);if(h){let e=null;if(a+n===0){[e,o]=o.splitText(a+d)}else{[,e,o]=o.splitText(a+n,a+n+d)}const t=F.Type.isPlainObject(l.attributes)?{...l.attributes}:{};if(!F.Type.isStringFilled(t.target)){t.target="_blank"}const i=P.$createAutoLinkNode(l.url,t);const r=L.$createTextNode(l.text);r.setFormat(e.getFormat());r.setDetail(e.getDetail());i.append(r);e.replace(i);s(l.url,null);a=0}else{a+=c}r=r.slice(Math.max(0,c));l=kc(r,t)}}function Qc(e,t,s){const i=e.getChildren();const r=i.length;for(let t=0;t<r;t++){const r=i[t];if(!L.$isTextNode(r)||!r.isSimpleText()){eh(e);s(null,e.getURL());return}}const a=e.getTextContent();const o=kc(a,t);if(o===null||o.text!==a){eh(e);s(null,e.getURL());return}if(!Gc(e)||!Vc(e)){eh(e);s(null,e.getURL());return}const l=e.getURL();if(l!==o.url){e.setURL(o.url);s(o.url,l)}if(o.attributes){const t=e.getRel();if(t!==o.attributes.rel){e.setRel(o.attributes.rel||null);s(o.attributes.rel||null,t)}const i=e.getTarget();if(i!==o.attributes.target){e.setTarget(o.attributes.target||null);s(o.attributes.target||null,i)}}}function Zc(e,t,s){const i=e.getPreviousSibling();const r=e.getNextSibling();const a=e.getTextContent();if(P.$isAutoLinkNode(i)&&(!zc(a)||Xc(a))){i.append(e);Qc(i,t,s);s(null,i.getURL())}if(P.$isAutoLinkNode(r)&&!Yc(a)){eh(r);Qc(r,t,s);s(null,r.getURL())}}function eh(e){const t=e.getChildren();const s=t.length;for(let i=s-1;i>=0;i--){e.insertAfter(t[i])}e.remove();return t.map((e=>e.getLatest()))}var th=Object.freeze({AutoLinkPlugin:$c});var sh=babelHelpers.classPrivateFieldLooseKey("registerListeners");class ih extends ie{constructor(e){super(e);Object.defineProperty(this,sh,{value:rh});babelHelpers.classPrivateFieldLooseBase(this,sh)[sh]()}static getName(){return"TabIndent"}}function rh(){this.cleanUpRegister(this.getEditor().registerCommand(L.KEY_TAB_COMMAND,(e=>{const t=L.$getSelection();if(!L.$isRangeSelection(t)){return false}return this.getEditor().dispatchCommand(e.shiftKey?L.OUTDENT_CONTENT_COMMAND:L.INDENT_CONTENT_COMMAND,{event:e,triggerByTab:true})}),L.COMMAND_PRIORITY_EDITOR),this.getEditor().registerCommand(L.INDENT_CONTENT_COMMAND,(()=>{const e=L.$getSelection();return!ah(e)}),L.COMMAND_PRIORITY_LOW),this.getEditor().registerCommand(L.OUTDENT_CONTENT_COMMAND,(()=>{const e=L.$getSelection();return!ah(e)}),L.COMMAND_PRIORITY_LOW))}function ah(e){if(!L.$isRangeSelection(e)){return false}const t=e.isBackward();const s=t?e.focus:e.anchor;const i=s.getNode();if(f.$isListItemNode(i)&&s.offset===0){return true}const r=y.$findMatchingParent(i,(e=>L.$isElementNode(e)&&!e.isInline()));return f.$isListItemNode(r)&&s.offset===0}var oh=Object.freeze({TabIndentPlugin:ih});var lh=babelHelpers.classPrivateFieldLooseKey("registerListeners");var nh=babelHelpers.classPrivateFieldLooseKey("registerComponents");var dh=babelHelpers.classPrivateFieldLooseKey("isIndentPermitted");var ch=babelHelpers.classPrivateFieldLooseKey("getElementNodesInSelection");class hh extends ie{constructor(e){super(e);Object.defineProperty(this,ch,{value:gh});Object.defineProperty(this,dh,{value:ph});Object.defineProperty(this,nh,{value:uh});Object.defineProperty(this,lh,{value:bh});babelHelpers.classPrivateFieldLooseBase(this,lh)[lh]();babelHelpers.classPrivateFieldLooseBase(this,nh)[nh]()}static getName(){return"List"}static getNodes(e){return[f.ListNode,f.ListItemNode]}importBBCode(){return{list:()=>({conversion:e=>({node:e.getValue()==="1"?f.$createListNode("number",1):f.$createListNode("bullet")}),priority:0}),"*":()=>({conversion:e=>({node:f.$createListItemNode()}),priority:0})}}exportBBCode(){return{list:e=>{const t=this.getEditor().getBBCodeScheme();const s=t.createElement({name:"list"});if(e.getListType()==="number"){s.setValue("1")}return{node:s}},listitem:e=>{const t=this.getEditor().getBBCodeScheme();return{node:t.createElement({name:"*"})}}}}validateScheme(){return{nodes:[{nodeClass:f.ListNode}],bbcodeMap:{list:"list",listitem:"*"}}}}function bh(){this.cleanUpRegister(this.getEditor().registerCommand(f.INSERT_ORDERED_LIST_COMMAND,(()=>{f.insertList(this.getLexicalEditor(),"number");return true}),L.COMMAND_PRIORITY_LOW),this.getEditor().registerCommand(f.INSERT_UNORDERED_LIST_COMMAND,(()=>{f.insertList(this.getLexicalEditor(),"bullet");return true}),L.COMMAND_PRIORITY_LOW),this.getEditor().registerCommand(f.REMOVE_LIST_COMMAND,(()=>{f.removeList(this.getLexicalEditor());return true}),L.COMMAND_PRIORITY_LOW),this.getEditor().registerCommand(L.INSERT_PARAGRAPH_COMMAND,(()=>f.$handleListInsertParagraph()),L.COMMAND_PRIORITY_LOW),this.getEditor().registerCommand(L.INDENT_CONTENT_COMMAND,(()=>!babelHelpers.classPrivateFieldLooseBase(this,dh)[dh](1)),L.COMMAND_PRIORITY_CRITICAL))}function uh(){this.getEditor().getComponentRegistry().register("bulleted-list",(()=>{const e=new ge;e.setContent('<span class="ui-icon-set --bulleted-list"></span>');e.setBlockType("bullet");e.setTooltip(F.Loc.getMessage("TEXT_EDITOR_BTN_BULLETED_LIST"));e.subscribe("onClick",(()=>{this.getEditor().focus();this.getEditor().update((()=>{if(e.isActive()){this.getEditor().dispatchCommand(f.REMOVE_LIST_COMMAND)}else{this.getEditor().dispatchCommand(f.INSERT_UNORDERED_LIST_COMMAND)}}))}));return e}));this.getEditor().getComponentRegistry().register("numbered-list",(()=>{const e=new ge;e.setContent('<span class="ui-icon-set --numbered-list"></span>');e.setTooltip(F.Loc.getMessage("TEXT_EDITOR_BTN_NUMBERED_LIST"));e.setBlockType("number");e.subscribe("onClick",(()=>{this.getEditor().focus();this.getEditor().update((()=>{if(e.isActive()){this.getEditor().dispatchCommand(f.REMOVE_LIST_COMMAND)}else{this.getEditor().dispatchCommand(f.INSERT_ORDERED_LIST_COMMAND)}}))}));return e}))}function ph(e){const t=L.$getSelection();if(!L.$isRangeSelection(t)){return false}const s=babelHelpers.classPrivateFieldLooseBase(this,ch)[ch](t);let i=0;for(const e of s){if(f.$isListNode(e)){i=Math.max(f.$getListDepth(e)+1,i)}else if(f.$isListItemNode(e)){const t=e.getParent();if(!f.$isListNode(t)){throw new Error("TextEditor: A ListItemNode must have a ListNode for a parent.")}i=Math.max(f.$getListDepth(t)+1,i)}}return i<=e}function gh(e){const t=e.getNodes();const s=e=>L.$isElementNode(e)&&!e.isInline();if(t.length===0){return new Set([y.$findMatchingParent(e.anchor.getNode(),s),y.$findMatchingParent(e.focus.getNode(),s)])}return new Set(t.map((e=>L.$isElementNode(e)?e:y.$findMatchingParent(e,s))))}var vh=Object.freeze({ListPlugin:hh});let fh=e=>e,Ph,mh,Lh,yh;var Fh=babelHelpers.classPrivateFieldLooseKey("popup");var Hh=babelHelpers.classPrivateFieldLooseKey("targetNode");var Bh=babelHelpers.classPrivateFieldLooseKey("refs");var Ch=babelHelpers.classPrivateFieldLooseKey("lastSelectedBox");var Oh=babelHelpers.classPrivateFieldLooseKey("handleMouseMove");var Th=babelHelpers.classPrivateFieldLooseKey("handleClick");var Eh=babelHelpers.classPrivateFieldLooseKey("highlightBoxes");class Nh extends b.EventEmitter{constructor(e){super();Object.defineProperty(this,Eh,{value:Dh});Object.defineProperty(this,Th,{value:Mh});Object.defineProperty(this,Oh,{value:_h});Object.defineProperty(this,Fh,{writable:true,value:null});Object.defineProperty(this,Hh,{writable:true,value:null});Object.defineProperty(this,Bh,{writable:true,value:new g.MemoryCache});Object.defineProperty(this,Ch,{writable:true,value:null});this.setEventNamespace("BX.UI.TextEditor.TableDialog");const t=F.Type.isPlainObject(e)?e:{};this.setTargetNode(t.targetNode);this.subscribeFromOptions(t.events)}show(){this.getPopup().adjustPosition({forceBindPosition:true});this.getPopup().show()}hide(){this.getPopup().close()}isShown(){return babelHelpers.classPrivateFieldLooseBase(this,Fh)[Fh]!==null&&babelHelpers.classPrivateFieldLooseBase(this,Fh)[Fh].isShown()}destroy(){this.getPopup().destroy()}setTargetNode(e){if(F.Type.isElementNode(e)){babelHelpers.classPrivateFieldLooseBase(this,Hh)[Hh]=e}}getTargetNode(){return babelHelpers.classPrivateFieldLooseBase(this,Hh)[Hh]}getPopup(){if(babelHelpers.classPrivateFieldLooseBase(this,Fh)[Fh]===null){const e=this.getTargetNode();const t=e.getBoundingClientRect();const s=t.width;babelHelpers.classPrivateFieldLooseBase(this,Fh)[Fh]=new p.Popup({autoHide:true,closeByEsc:true,padding:0,content:F.Tag.render(Ph||(Ph=fh`
					<div class="ui-text-editor-table-dialog" onclick="${0}">
						${0}
						${0}
					</div>
				`),babelHelpers.classPrivateFieldLooseBase(this,Th)[Th].bind(this),this.getGridContainer(),this.getCaptionContainer()),bindElement:this.getTargetNode(),events:{onClose:()=>{this.emit("onClose")},onDestroy:()=>{this.emit("onDestroy")},onShow:e=>{const t=e.getTarget();const i=t.getPopupContainer().offsetWidth;const r=s/2-i/2;const a=p.Popup.getOption("angleLeftOffset")-p.Popup.getOption("angleMinTop");t.setAngle({offset:i/2-a});t.setOffset({offsetLeft:r+p.Popup.getOption("angleLeftOffset")});babelHelpers.classPrivateFieldLooseBase(this,Ch)[Ch]=null;babelHelpers.classPrivateFieldLooseBase(this,Eh)[Eh](1,1)}}})}return babelHelpers.classPrivateFieldLooseBase(this,Fh)[Fh]}getGridContainer(){return babelHelpers.classPrivateFieldLooseBase(this,Bh)[Bh].remember("grid",(()=>{const e=[];for(let t=0;t<100;t++){const s=Math.floor(t/10);const i=t%10;e.push(F.Tag.render(mh||(mh=fh`
					<button
						class="ui-text-editor-table-dialog-box"
						data-column="${0}"
						data-row="${0}"
					></button>
				`),i+1,s+1))}return F.Tag.render(Lh||(Lh=fh`
				<div 
					class="ui-text-editor-table-dialog-grid" 
					onmousemove="${0}"
				>${0}</div>
			`),babelHelpers.classPrivateFieldLooseBase(this,Oh)[Oh].bind(this),e)}))}getCaptionContainer(){return babelHelpers.classPrivateFieldLooseBase(this,Bh)[Bh].remember("caption",(()=>F.Tag.render(yh||(yh=fh`<div class="ui-text-editor-table-dialog-caption"></div>`))))}}function _h(e){if(babelHelpers.classPrivateFieldLooseBase(this,Ch)[Ch]!==e.target&&F.Dom.hasClass(e.target,"ui-text-editor-table-dialog-box")){const{row:t,column:s}=e.target.dataset;babelHelpers.classPrivateFieldLooseBase(this,Eh)[Eh](t,s);babelHelpers.classPrivateFieldLooseBase(this,Ch)[Ch]=e.target}}function Mh(e){if(babelHelpers.classPrivateFieldLooseBase(this,Ch)[Ch]){const{row:e,column:t}=babelHelpers.classPrivateFieldLooseBase(this,Ch)[Ch].dataset;this.emit("onSelect",{rows:e,columns:t})}}function Dh(e,t){let s=0;for(const i of this.getGridContainer().children){const r=Math.floor(s/10);const a=s%10;const o=r<e&&a<t;if(o){F.Dom.addClass(i,"--selected")}else{F.Dom.removeClass(i,"--selected")}s++}this.getCaptionContainer().textContent=e&&t?`${e} x ${t}`:""}const Sh=L.createCommand("INSERT_TABLE_DIALOG_COMMAND");var Rh=babelHelpers.classPrivateFieldLooseKey("tableDialog");var Ih=babelHelpers.classPrivateFieldLooseKey("registerComponents");var xh=babelHelpers.classPrivateFieldLooseKey("registerCommands");var wh=babelHelpers.classPrivateFieldLooseKey("registerListeners");class Ah extends ie{constructor(e){super(e);Object.defineProperty(this,wh,{value:jh});Object.defineProperty(this,xh,{value:Kh});Object.defineProperty(this,Ih,{value:$h});Object.defineProperty(this,Rh,{writable:true,value:null});babelHelpers.classPrivateFieldLooseBase(this,xh)[xh]();babelHelpers.classPrivateFieldLooseBase(this,wh)[wh]();babelHelpers.classPrivateFieldLooseBase(this,Ih)[Ih]()}static getName(){return"Table"}static getNodes(e){return[h.TableNode,h.TableCellNode,h.TableRowNode]}importBBCode(){return{table:()=>({conversion:e=>({node:h.$createTableNode()}),priority:0}),tr:()=>({conversion:e=>({node:h.$createTableRowNode()}),priority:0}),td:()=>({conversion:e=>({node:h.$createTableCellNode(),after:e=>U(e)}),priority:0}),th:()=>({conversion:e=>({node:h.$createTableCellNode(h.TableCellHeaderStates.ROW),after:e=>U(e)}),priority:0})}}exportBBCode(){return{table:()=>{const e=this.getEditor().getBBCodeScheme();return{node:e.createElement({name:"table"})}},tablerow:()=>{const e=this.getEditor().getBBCodeScheme();return{node:e.createElement({name:"tr"})}},tablecell:e=>{const t=this.getEditor().getBBCodeScheme();return{node:t.createElement({name:e.hasHeader()?"th":"td"})}}}}validateScheme(){return{nodes:[{nodeClass:h.TableNode,validate:e=>{if(e.getChildrenSize()===0){e.remove();return true}return false}},{nodeClass:h.TableCellNode,validate:e=>{e.getChildren().forEach((e=>{if(k(e)){const t=L.$createParagraphNode();e.replace(t);t.append(e)}}));return false}}],bbcodeMap:{table:"table",tablerow:"tr",tablecell:"td"}}}destroy(){super.destroy();if(babelHelpers.classPrivateFieldLooseBase(this,Rh)[Rh]!==null){babelHelpers.classPrivateFieldLooseBase(this,Rh)[Rh].destroy()}}}function $h(){this.getEditor().getComponentRegistry().register("table",(()=>{const e=new ge;e.setContent('<span class="ui-icon-set --table-editor"></span>');e.setTooltip(F.Loc.getMessage("TEXT_EDITOR_BTN_TABLE"));e.subscribe("onClick",(()=>{this.getEditor().dispatchCommand(Sh,{targetNode:e.getContainer()})}));return e}))}function Kh(){this.cleanUpRegister(this.getEditor().registerCommand(h.INSERT_TABLE_COMMAND,(({columns:e,rows:t})=>{const s=Math.max(1,F.Text.toNumber(t));const i=Math.max(1,F.Text.toNumber(e));const r=h.$createTableNodeWithDimensions(s,i,false);y.$insertNodeToNearestRoot(r);const a=r.getFirstDescendant();if(L.$isTextNode(a)){a.select()}return true}),L.COMMAND_PRIORITY_EDITOR),this.getEditor().registerCommand(Sh,(e=>{if(!F.Type.isPlainObject(e)||!F.Type.isElementNode(e.targetNode)){return false}if(babelHelpers.classPrivateFieldLooseBase(this,Rh)[Rh]!==null){if(babelHelpers.classPrivateFieldLooseBase(this,Rh)[Rh].getTargetNode()===e.targetNode){babelHelpers.classPrivateFieldLooseBase(this,Rh)[Rh].show();return true}babelHelpers.classPrivateFieldLooseBase(this,Rh)[Rh].destroy()}babelHelpers.classPrivateFieldLooseBase(this,Rh)[Rh]=new Nh({targetNode:e.targetNode,events:{onSelect:e=>{this.getEditor().dispatchCommand(h.INSERT_TABLE_COMMAND,e.getData());babelHelpers.classPrivateFieldLooseBase(this,Rh)[Rh].hide()},onDestroy:()=>{babelHelpers.classPrivateFieldLooseBase(this,Rh)[Rh]=null}}});babelHelpers.classPrivateFieldLooseBase(this,Rh)[Rh].show();return true}),L.COMMAND_PRIORITY_LOW),this.getEditor().registerCommand(H,(()=>{if(babelHelpers.classPrivateFieldLooseBase(this,Rh)[Rh]!==null){babelHelpers.classPrivateFieldLooseBase(this,Rh)[Rh].hide()}return false}),L.COMMAND_PRIORITY_LOW),this.getEditor().registerCommand(B,(()=>babelHelpers.classPrivateFieldLooseBase(this,Rh)[Rh]!==null&&babelHelpers.classPrivateFieldLooseBase(this,Rh)[Rh].isShown()),L.COMMAND_PRIORITY_LOW))}function jh(){const e=new Map;const t=t=>{const s=t.getKey();const i=this.getEditor().getElementByKey(s);if(i&&!e.has(s)){const r=h.applyTableHandlers(t,i,this.getLexicalEditor(),true);e.set(s,r)}};this.cleanUpRegister(this.getEditor().registerMutationListener(h.TableNode,(s=>{for(const[i,r]of s){if(r==="created"){this.getEditor().getEditorState().read((()=>{const e=L.$getNodeByKey(i);if(h.$isTableNode(e)){t(e)}}))}else if(r==="destroyed"){const t=e.get(i);if(t!==undefined){t.removeListeners();e.delete(i)}}}})))}var kh=Object.freeze({INSERT_TABLE_DIALOG_COMMAND:Sh,TablePlugin:Ah});class Uh extends L.TextNode{static getType(){return"hashtag"}static clone(e){return new Uh(e.__text,e.__key)}constructor(e,t){super(e,t)}createDOM(e){var t;const s=super.createDOM(e);if(F.Type.isStringFilled(e==null?void 0:(t=e.theme)==null?void 0:t.hashtag)){F.Dom.addClass(s,e.theme.hashtag)}return s}static importJSON(e){const t=Wh(e.text);t.setFormat(e.format);t.setDetail(e.detail);t.setMode(e.mode);t.setStyle(e.style);return t}exportJSON(){return{...super.exportJSON(),type:"hashtag"}}canInsertTextBefore(){return false}isTextEntity(){return true}}function Wh(e=""){return L.$applyNodeReplacement(new Uh(e))}function Yh(e){return e instanceof Uh}var zh=babelHelpers.classPrivateFieldLooseKey("registerListeners");class Xh extends ie{constructor(e){super(e);Object.defineProperty(this,zh,{value:Gh});babelHelpers.classPrivateFieldLooseBase(this,zh)[zh]()}static getName(){return"Hashtag"}static getNodes(e){return[Uh]}importBBCode(){return null}exportBBCode(){return{hashtag:(e,t)=>{const s=this.getEditor().getBBCodeScheme();return{node:s.createText(e.getTextContent())}}}}validateScheme(){return{bbcodeMap:{hashtag:"#text"}}}}function Gh(){const e=e=>Wh(e.getTextContent());const t=e=>{const t=/(?<=\s+|^)#([^\s,.<>[\]]+)/is.exec(e);if(t===null){return null}const s=t[0].length;const i=t.index;const r=i+s;return{end:r,start:i}};this.cleanUpRegister(...m.registerLexicalTextEntity(this.getLexicalEditor(),t,Uh,e))}var Vh=Object.freeze({HashtagNode:Uh,$createHashtagNode:Wh,$isHashtagNode:Yh,HashtagPlugin:Xh});function Jh(e){if(!F.Type.isStringFilled(e)){return[]}const t=[];const s=e.split(/(\r?\n|\t)/);const i=s.length;for(let e=0;e<i;e++){const i=s[e];if(i==="\n"||i==="\r\n"){t.push(L.$createLineBreakNode())}else if(i==="\t"){t.push(L.$createTabNode())}else{t.push(L.$createTextNode(i))}}return t}let qh=e=>e,Qh;const Zh=L.createCommand("INSERT_COPILOT_DIALOG_COMMAND");const eb={INIT:"init",LOADING:"loading",LOADED:"loaded"};var tb=babelHelpers.classPrivateFieldLooseKey("copilot");var sb=babelHelpers.classPrivateFieldLooseKey("copilotStatus");var ib=babelHelpers.classPrivateFieldLooseKey("copilotOptions");var rb=babelHelpers.classPrivateFieldLooseKey("targetParagraph");var ab=babelHelpers.classPrivateFieldLooseKey("lastSelection");var ob=babelHelpers.classPrivateFieldLooseKey("onEditorScroll");var lb=babelHelpers.classPrivateFieldLooseKey("triggerBySpace");var nb=babelHelpers.classPrivateFieldLooseKey("registerListeners");var db=babelHelpers.classPrivateFieldLooseKey("registerParagraphNodeTransform");var cb=babelHelpers.classPrivateFieldLooseKey("registerComponents");var hb=babelHelpers.classPrivateFieldLooseKey("show");var bb=babelHelpers.classPrivateFieldLooseKey("hide");var ub=babelHelpers.classPrivateFieldLooseKey("createCopilot");var pb=babelHelpers.classPrivateFieldLooseKey("resetLoader");var gb=babelHelpers.classPrivateFieldLooseKey("adjustDialogPosition");var vb=babelHelpers.classPrivateFieldLooseKey("handleEditorScroll");var fb=babelHelpers.classPrivateFieldLooseKey("restoreSelection");var Pb=babelHelpers.classPrivateFieldLooseKey("handleCopilotSave");var mb=babelHelpers.classPrivateFieldLooseKey("handleCopilotAddBelow");var Lb=babelHelpers.classPrivateFieldLooseKey("handleCopilotHide");class yb extends ie{constructor(e){super(e);Object.defineProperty(this,Lb,{value:Rb});Object.defineProperty(this,mb,{value:Sb});Object.defineProperty(this,Pb,{value:Db});Object.defineProperty(this,fb,{value:Mb});Object.defineProperty(this,vb,{value:_b});Object.defineProperty(this,gb,{value:Nb});Object.defineProperty(this,pb,{value:Eb});Object.defineProperty(this,ub,{value:Tb});Object.defineProperty(this,bb,{value:Ob});Object.defineProperty(this,hb,{value:Cb});Object.defineProperty(this,cb,{value:Bb});Object.defineProperty(this,db,{value:Hb});Object.defineProperty(this,nb,{value:Fb});Object.defineProperty(this,tb,{writable:true,value:null});Object.defineProperty(this,sb,{writable:true,value:eb.INIT});Object.defineProperty(this,ib,{writable:true,value:null});Object.defineProperty(this,rb,{writable:true,value:null});Object.defineProperty(this,ab,{writable:true,value:null});Object.defineProperty(this,ob,{writable:true,value:babelHelpers.classPrivateFieldLooseBase(this,vb)[vb].bind(this)});Object.defineProperty(this,lb,{writable:true,value:false});babelHelpers.classPrivateFieldLooseBase(this,ib)[ib]=e.getOption("copilot.copilotOptions");if(F.Type.isPlainObject(babelHelpers.classPrivateFieldLooseBase(this,ib)[ib])){babelHelpers.classPrivateFieldLooseBase(this,nb)[nb]();babelHelpers.classPrivateFieldLooseBase(this,cb)[cb]()}}static getName(){return"Copilot"}shouldTriggerBySpace(){return babelHelpers.classPrivateFieldLooseBase(this,lb)[lb]}isCopilotLoaded(){return babelHelpers.classPrivateFieldLooseBase(this,sb)[sb]===eb.LOADED}isCopilotLoading(){return babelHelpers.classPrivateFieldLooseBase(this,sb)[sb]===eb.LOADING}isCopilotShown(){return babelHelpers.classPrivateFieldLooseBase(this,tb)[tb]!==null&&babelHelpers.classPrivateFieldLooseBase(this,tb)[tb].isShown()}show({onShow:e,onError:t}={}){if(this.isCopilotLoaded()){babelHelpers.classPrivateFieldLooseBase(this,hb)[hb]({onShow:e})}else if(!this.isCopilotLoading()){babelHelpers.classPrivateFieldLooseBase(this,ub)[ub]().then((()=>{babelHelpers.classPrivateFieldLooseBase(this,hb)[hb]({onShow:e})})).catch((()=>{if(F.Type.isFunction(t)){t()}}))}}destroy(){super.destroy();if(babelHelpers.classPrivateFieldLooseBase(this,tb)[tb]!==null){babelHelpers.classPrivateFieldLooseBase(this,tb)[tb].hide();babelHelpers.classPrivateFieldLooseBase(this,tb)[tb]=null}}}function Fb(){babelHelpers.classPrivateFieldLooseBase(this,lb)[lb]=this.getEditor().getOption("copilot.triggerBySpace",false);this.cleanUpRegister(this.getEditor().registerCommand(Zh,(e=>{const t=F.Type.isPlainObject(e)?e:{};this.show(t);return true}),L.COMMAND_PRIORITY_EDITOR),this.getEditor().registerCommand(H,(()=>{babelHelpers.classPrivateFieldLooseBase(this,bb)[bb]();return false}),L.COMMAND_PRIORITY_LOW),this.getEditor().registerCommand(B,(()=>this.isCopilotShown()),L.COMMAND_PRIORITY_LOW),babelHelpers.classPrivateFieldLooseBase(this,lb)[lb]?babelHelpers.classPrivateFieldLooseBase(this,db)[db]():()=>{})}function Hb(){return this.getEditor().registerNodeTransform(pt,(e=>{if(e.getChildrenSize()!==1||!L.$isRootNode(e.getParent())){return}if(!L.$isTextNode(e.getFirstChild())||e.getFirstChild().getTextContent()!==" "){babelHelpers.classPrivateFieldLooseBase(this,pb)[pb]();return}const t=L.$getSelection();if(!L.$isRangeSelection(t)||!t.isCollapsed()){return}const s=t.anchor.getNode();if(s!==e.getFirstChild()){return}if(!this.isCopilotLoaded()&&!this.isCopilotLoading()){babelHelpers.classPrivateFieldLooseBase(this,pb)[pb]();babelHelpers.classPrivateFieldLooseBase(this,rb)[rb]=this.getEditor().getElementByKey(e.getKey());if(babelHelpers.classPrivateFieldLooseBase(this,rb)[rb]){F.Dom.addClass(babelHelpers.classPrivateFieldLooseBase(this,rb)[rb],"ui-text-editor-loading-ellipsis")}}e.getFirstChild().remove();e.select();this.show({onShow:()=>babelHelpers.classPrivateFieldLooseBase(this,pb)[pb](),onError:()=>babelHelpers.classPrivateFieldLooseBase(this,pb)[pb]()})}))}function Bb(){this.getEditor().getComponentRegistry().register("copilot",(()=>{const e=new ge;const t="--copilot-ai";const s="--refresh-5 ui-text-editor-copilot-loading";const i=F.Tag.render(Qh||(Qh=qh`
				<span class="ui-icon-set ${0}" style="--ui-icon-set__icon-color: #8e52ec"></span>
			`),t);e.setContent(i);e.setTooltip(F.Loc.getMessage("TEXT_EDITOR_BTN_COPILOT"));e.subscribe("onClick",(()=>{this.getEditor().focus();if(this.isCopilotLoading()){return}const e=()=>{if(!F.Dom.hasClass(i,t)){F.Dom.removeClass(i,s);F.Dom.addClass(i,t)}};this.getEditor().dispatchCommand(Zh,{onShow:e,onError:e});if(!this.isCopilotLoaded()){setTimeout((()=>{if(!this.isCopilotLoaded()){F.Dom.removeClass(i,t);F.Dom.addClass(i,s)}}),500)}}));return e}))}function Cb({onShow:e}={}){this.getEditor().update((()=>{const t=L.$getSelection();if(!L.$isRangeSelection(t)||!this.getEditor().isEditable()){return}this.getEditor().dispatchCommand(H);const s=t.getTextContent();const i=F.Dom.getPosition(this.getEditor().getScrollerContainer());const r=Math.min(i.width,600);babelHelpers.classPrivateFieldLooseBase(this,ab)[ab]=t.clone();const a=s.trim();if(a.length>0){babelHelpers.classPrivateFieldLooseBase(this,tb)[tb].setSelectedText(a)}else{const e=L.$getRoot().getTextContent().trim();if(e.length>0){babelHelpers.classPrivateFieldLooseBase(this,tb)[tb].setContext(e)}}babelHelpers.classPrivateFieldLooseBase(this,tb)[tb].show({width:r});babelHelpers.classPrivateFieldLooseBase(this,gb)[gb]();F.Event.bind(this.getEditor().getScrollerContainer(),"scroll",babelHelpers.classPrivateFieldLooseBase(this,ob)[ob]);if(!t.isCollapsed()){this.getEditor().highlightSelection()}if(F.Type.isFunction(e)){e()}}))}function Ob(){if(this.isCopilotLoaded()&&babelHelpers.classPrivateFieldLooseBase(this,tb)[tb].isShown()){babelHelpers.classPrivateFieldLooseBase(this,tb)[tb].hide()}}function Tb(){if(this.isDestroyed()){return Promise.reject(new Error("Copilot plugin was destroyed."))}babelHelpers.classPrivateFieldLooseBase(this,sb)[sb]=eb.LOADING;return new Promise(((e,t)=>{F.Runtime.loadExtension("ai.copilot").then((({Copilot:s,CopilotEvents:i})=>{if(this.isDestroyed()){t(new Error("Copilot plugin was destroyed."));return}babelHelpers.classPrivateFieldLooseBase(this,tb)[tb]=new s({showResultInCopilot:true,...babelHelpers.classPrivateFieldLooseBase(this,ib)[ib],autoHide:true});babelHelpers.classPrivateFieldLooseBase(this,tb)[tb].subscribe(i.FINISH_INIT,(()=>{if(this.isDestroyed()){t(new Error("Copilot plugin was destroyed."));return}babelHelpers.classPrivateFieldLooseBase(this,sb)[sb]=eb.LOADED;e()}));babelHelpers.classPrivateFieldLooseBase(this,tb)[tb].subscribe(i.TEXT_SAVE,babelHelpers.classPrivateFieldLooseBase(this,Pb)[Pb].bind(this));babelHelpers.classPrivateFieldLooseBase(this,tb)[tb].subscribe(i.TEXT_PLACE_BELOW,babelHelpers.classPrivateFieldLooseBase(this,mb)[mb].bind(this));babelHelpers.classPrivateFieldLooseBase(this,tb)[tb].subscribe(i.HIDE,babelHelpers.classPrivateFieldLooseBase(this,Lb)[Lb].bind(this));babelHelpers.classPrivateFieldLooseBase(this,tb)[tb].init()})).catch((()=>{t()}))}))}function Eb(){if(babelHelpers.classPrivateFieldLooseBase(this,rb)[rb]){F.Dom.removeClass(babelHelpers.classPrivateFieldLooseBase(this,rb)[rb],"ui-text-editor-loading-ellipsis")}}function Nb(){this.getEditor().update((()=>{babelHelpers.classPrivateFieldLooseBase(this,fb)[fb]();const e=Jr(this.getEditor(),L.$getSelection(),document.body);if(e===null){return}const{top:t,left:s,bottom:i}=e;const r=F.Dom.getPosition(this.getEditor().getScrollerContainer());const a=Math.min(r.width,600);const o=Vr(this.getEditor());let l=a/2;if(s-l<r.left){const e=r.left-(s-l);l-=e+o.left}else if(r.right<s+a-l){l+=s+a-l-r.right+o.right}if(i<r.top||t>r.bottom){babelHelpers.classPrivateFieldLooseBase(this,tb)[tb].adjust({hide:true})}else{babelHelpers.classPrivateFieldLooseBase(this,tb)[tb].adjust({hide:false,position:{left:s-l,top:i}})}}))}function _b(){babelHelpers.classPrivateFieldLooseBase(this,gb)[gb]()}function Mb(){const e=L.$getSelection();if(!L.$isRangeSelection(e)&&babelHelpers.classPrivateFieldLooseBase(this,ab)[ab]!==null){L.$setSelection(babelHelpers.classPrivateFieldLooseBase(this,ab)[ab]);babelHelpers.classPrivateFieldLooseBase(this,ab)[ab]=null;return true}return false}function Db(e){const{result:t}=e.getData();this.getEditor().update((()=>{babelHelpers.classPrivateFieldLooseBase(this,fb)[fb]();const e=L.$getSelection();if(L.$isRangeSelection(e)){e.insertRawText(t)}babelHelpers.classPrivateFieldLooseBase(this,bb)[bb]()}))}function Sb(e){const{result:t}=e.getData();this.getEditor().update((()=>{babelHelpers.classPrivateFieldLooseBase(this,fb)[fb]();const e=L.$getSelection();if(L.$isRangeSelection(e)){const s=e.focus;const i=s.getNode();if(!e.isCollapsed()){i.selectEnd()}const r=i.getParent();if(L.$isParagraphNode(r)){const e=L.$createParagraphNode();e.append(...Jh(t));r.insertAfter(e)}else{e.insertLineBreak();e.insertRawText(t)}}babelHelpers.classPrivateFieldLooseBase(this,bb)[bb]()}))}function Rb(){F.Event.unbind(this.getEditor().getScrollerContainer(),"scroll",babelHelpers.classPrivateFieldLooseBase(this,ob)[ob]);this.getEditor().resetHighlightSelection();this.getEditor().update((()=>{if(!babelHelpers.classPrivateFieldLooseBase(this,fb)[fb]()){this.getEditor().focus()}}))}var Ib=Object.freeze({INSERT_COPILOT_DIALOG_COMMAND:Zh,CopilotPlugin:yb});var xb=babelHelpers.classPrivateFieldLooseKey("registerComponents");class wb extends ie{constructor(e){super(e);Object.defineProperty(this,xb,{value:Ab});const t=u.createEmptyHistoryState();this.cleanUpRegister(u.registerHistory(e.getLexicalEditor(),t,1e3));babelHelpers.classPrivateFieldLooseBase(this,xb)[xb]()}static getName(){return"History"}}function Ab(){let e=false;this.getEditor().getComponentRegistry().register("undo",(()=>{const t=new ge;t.setContent('<span class="ui-icon-set --undo"></span>');t.setDisabled(!e);t.setTooltip(F.Loc.getMessage("TEXT_EDITOR_BTN_UNDO",{"#keystroke#":F.Browser.isMac()?"\u2318Z":"Ctrl+Z"}));t.subscribe("onClick",(()=>{this.getEditor().dispatchCommand(L.UNDO_COMMAND)}));t.setDisableCallback((()=>!e||!this.getEditor().isEditable()));this.getEditor().registerCommand(L.CAN_UNDO_COMMAND,(s=>{e=s;t.setDisabled(!e);return false}),L.COMMAND_PRIORITY_CRITICAL);return t}));let t=false;this.getEditor().getComponentRegistry().register("redo",(()=>{const e=new ge;e.setContent('<span class="ui-icon-set --redo"></span>');e.setDisabled(!t);e.setTooltip(F.Loc.getMessage("TEXT_EDITOR_BTN_REDO",{"#keystroke#":F.Browser.isMac()?"\u2318\u21e7Z":"Ctrl+Y"}));e.subscribe("onClick",(()=>{this.getEditor().dispatchCommand(L.REDO_COMMAND)}));e.setDisableCallback((()=>!t||!this.getEditor().isEditable()));this.getEditor().registerCommand(L.CAN_REDO_COMMAND,(s=>{t=s;e.setDisabled(!t);return false}),L.COMMAND_PRIORITY_CRITICAL);return e}))}var $b=Object.freeze({HistoryPlugin:wb});let Kb=e=>e,jb,kb;const Ub={DOWNWARD:1,UPWARD:-1,INDETERMINATE:0};const Wb="application/x-ui-text-editor-drag-block";var Yb=babelHelpers.classPrivateFieldLooseKey("draggableBlockElement");var zb=babelHelpers.classPrivateFieldLooseKey("lastBlockElementIndex");var Xb=babelHelpers.classPrivateFieldLooseKey("lastTargetElement");var Gb=babelHelpers.classPrivateFieldLooseKey("container");var Vb=babelHelpers.classPrivateFieldLooseKey("dropLine");var Jb=babelHelpers.classPrivateFieldLooseKey("isDragging");var qb=babelHelpers.classPrivateFieldLooseKey("bodyDragDropHandler");var Qb=babelHelpers.classPrivateFieldLooseKey("bodyDragOverHandler");var Zb=babelHelpers.classPrivateFieldLooseKey("registerEvents");var eu=babelHelpers.classPrivateFieldLooseKey("registerListeners");var tu=babelHelpers.classPrivateFieldLooseKey("handleMouseMove");var su=babelHelpers.classPrivateFieldLooseKey("handleMouseLeave");var iu=babelHelpers.classPrivateFieldLooseKey("findBlockElement");var ru=babelHelpers.classPrivateFieldLooseKey("getCurrentIndex");var au=babelHelpers.classPrivateFieldLooseKey("updatePosition");var ou=babelHelpers.classPrivateFieldLooseKey("setDraggableBlockElement");var lu=babelHelpers.classPrivateFieldLooseKey("handleDragStart");var nu=babelHelpers.classPrivateFieldLooseKey("handleDragEnd");var du=babelHelpers.classPrivateFieldLooseKey("handleDragOver");var cu=babelHelpers.classPrivateFieldLooseKey("handleDragDrop");var hu=babelHelpers.classPrivateFieldLooseKey("showDropLine");var bu=babelHelpers.classPrivateFieldLooseKey("hideDropLine");class uu extends ie{constructor(e){super(e);Object.defineProperty(this,bu,{value:Tu});Object.defineProperty(this,hu,{value:Ou});Object.defineProperty(this,cu,{value:Cu});Object.defineProperty(this,du,{value:Bu});Object.defineProperty(this,nu,{value:Hu});Object.defineProperty(this,lu,{value:Fu});Object.defineProperty(this,ou,{value:yu});Object.defineProperty(this,au,{value:Lu});Object.defineProperty(this,ru,{value:mu});Object.defineProperty(this,iu,{value:Pu});Object.defineProperty(this,su,{value:fu});Object.defineProperty(this,tu,{value:vu});Object.defineProperty(this,eu,{value:gu});Object.defineProperty(this,Zb,{value:pu});Object.defineProperty(this,Yb,{writable:true,value:null});Object.defineProperty(this,zb,{writable:true,value:Infinity});Object.defineProperty(this,Xb,{writable:true,value:null});Object.defineProperty(this,Gb,{writable:true,value:null});Object.defineProperty(this,Vb,{writable:true,value:null});Object.defineProperty(this,Jb,{writable:true,value:false});Object.defineProperty(this,qb,{writable:true,value:null});Object.defineProperty(this,Qb,{writable:true,value:null});this.cleanUpRegister(babelHelpers.classPrivateFieldLooseBase(this,Zb)[Zb](),babelHelpers.classPrivateFieldLooseBase(this,eu)[eu]());babelHelpers.classPrivateFieldLooseBase(this,qb)[qb]=e=>{this.getEditor().dispatchCommand(L.DROP_COMMAND,e)};babelHelpers.classPrivateFieldLooseBase(this,Qb)[Qb]=e=>{e.preventDefault()};F.Dom.append(this.getContainer(),this.getEditor().getScrollerContainer());F.Dom.append(this.getDropLine(),this.getEditor().getScrollerContainer())}static getName(){return"BlockToolbar"}getContainer(){if(babelHelpers.classPrivateFieldLooseBase(this,Gb)[Gb]===null){babelHelpers.classPrivateFieldLooseBase(this,Gb)[Gb]=F.Tag.render(jb||(jb=Kb`
			...
			`),babelHelpers.classPrivateFieldLooseBase(this,lu)[lu].bind(this),babelHelpers.classPrivateFieldLooseBase(this,nu)[nu].bind(this))}return babelHelpers.classPrivateFieldLooseBase(this,Gb)[Gb]}getDropLine(){if(babelHelpers.classPrivateFieldLooseBase(this,Vb)[Vb]===null){babelHelpers.classPrivateFieldLooseBase(this,Vb)[Vb]=F.Tag.render(kb||(kb=Kb`
				<div class="ui-text-editor-block-drop-line"></div>
			`))}return babelHelpers.classPrivateFieldLooseBase(this,Vb)[Vb]}destroy(){super.destroy();F.Dom.remove(this.getContainer());F.Dom.remove(this.getDropLine())}}function pu(){const e=this.getEditor().getScrollerContainer();const t=babelHelpers.classPrivateFieldLooseBase(this,tu)[tu].bind(this);const s=babelHelpers.classPrivateFieldLooseBase(this,su)[su].bind(this);F.Event.bind(e,"mousemove",t);F.Event.bind(e,"mouseleave",s);return()=>{F.Event.unbind(e,"mousemove",t);F.Event.unbind(e,"mouseleave",s)}}function gu(){return y.mergeRegister(this.getEditor().registerCommand(L.DRAGOVER_COMMAND,babelHelpers.classPrivateFieldLooseBase(this,du)[du].bind(this),L.COMMAND_PRIORITY_LOW),this.getEditor().registerCommand(L.DROP_COMMAND,babelHelpers.classPrivateFieldLooseBase(this,cu)[cu].bind(this),L.COMMAND_PRIORITY_HIGH),this.getEditor().registerTextContentListener((()=>{babelHelpers.classPrivateFieldLooseBase(this,ou)[ou](null);babelHelpers.classPrivateFieldLooseBase(this,au)[au]()})))}function vu(e){if(!this.getEditor().isEditable()){return}const t=e.target;if(!(t instanceof HTMLElement)){babelHelpers.classPrivateFieldLooseBase(this,ou)[ou](null);return}if(t.closest(".ui-text-editor-block-toolbar")!==null){return}const s=babelHelpers.classPrivateFieldLooseBase(this,iu)[iu](e);babelHelpers.classPrivateFieldLooseBase(this,ou)[ou](s)}function fu(){babelHelpers.classPrivateFieldLooseBase(this,ou)[ou](null)}function Pu(e){const t=this.getEditor().getScrollerContainer();const s=t.getBoundingClientRect();let i=null;this.getEditor().getEditorState().read((()=>{const t=L.$getRoot();const r=t.getChildrenKeys();let a=babelHelpers.classPrivateFieldLooseBase(this,ru)[ru](r.length);let o=Ub.INDETERMINATE;while(a>=0&&a<r.length){const t=r[a];const l=this.getEditor().getElementByKey(t);if(l===null){break}const n=l.getBoundingClientRect();const{marginLeft:d,marginRight:c,marginTop:h,marginBottom:b}=window.getComputedStyle(l);const u=new DOMRect(s.left+parseFloat(d),n.y-parseFloat(h),n.width+parseFloat(c),n.height+parseFloat(b));const{x:p,y:g}=e;const v=g<u.top;const f=g>u.bottom;const P=p<u.left;const m=p>u.right;const L=!v&&!f&&!P&&!m;if(L){i=l;babelHelpers.classPrivateFieldLooseBase(this,zb)[zb]=a;break}if(o===Ub.INDETERMINATE){if(v){o=Ub.UPWARD}else if(f){o=Ub.DOWNWARD}else{o=Infinity}}a+=o}}));return i}function mu(e){if(e===0){return Infinity}if(babelHelpers.classPrivateFieldLooseBase(this,zb)[zb]>=0&&babelHelpers.classPrivateFieldLooseBase(this,zb)[zb]<e){return babelHelpers.classPrivateFieldLooseBase(this,zb)[zb]}return Math.floor(e/2)}function Lu(){if(babelHelpers.classPrivateFieldLooseBase(this,Yb)[Yb]===null){F.Dom.style(this.getContainer(),{opacity:0,transform:"translateY(-10000px)"})}else{const e=F.Text.toNumber(F.Dom.style(babelHelpers.classPrivateFieldLooseBase(this,Yb)[Yb],"margin-top"));const t=babelHelpers.classPrivateFieldLooseBase(this,Yb)[Yb].offsetTop+e;F.Dom.style(this.getContainer(),{opacity:1,transform:`translateY(${t}px)`})}}function yu(e){const t=babelHelpers.classPrivateFieldLooseBase(this,Yb)[Yb]!==e;babelHelpers.classPrivateFieldLooseBase(this,Yb)[Yb]=e;if(t){babelHelpers.classPrivateFieldLooseBase(this,au)[au]()}}function Fu(e){const t=e.dataTransfer;if(!t||babelHelpers.classPrivateFieldLooseBase(this,Yb)[Yb]===null){return}this.getEditor().dispatchCommand(H);t.setDragImage(babelHelpers.classPrivateFieldLooseBase(this,Yb)[Yb],0,0);let s="";this.getEditor().update((()=>{const e=L.$getNearestNodeFromDOMNode(babelHelpers.classPrivateFieldLooseBase(this,Yb)[Yb]);if(e){s=e.getKey()}}));t.setData(Wb,s);babelHelpers.classPrivateFieldLooseBase(this,Jb)[Jb]=true;F.Event.bind(document.body,"drop",babelHelpers.classPrivateFieldLooseBase(this,qb)[qb]);F.Event.bind(document.body,"dragover",babelHelpers.classPrivateFieldLooseBase(this,Qb)[Qb])}function Hu(e){babelHelpers.classPrivateFieldLooseBase(this,Jb)[Jb]=false;babelHelpers.classPrivateFieldLooseBase(this,bu)[bu]();F.Event.unbind(document.body,"drop",babelHelpers.classPrivateFieldLooseBase(this,qb)[qb]);F.Event.unbind(document.body,"dragover",babelHelpers.classPrivateFieldLooseBase(this,Qb)[Qb])}function Bu(e){if(babelHelpers.classPrivateFieldLooseBase(this,Jb)[Jb]===false){return false}const t=e.dataTransfer.types.includes("Files");if(t||!(e.target instanceof HTMLElement)){return false}const s=babelHelpers.classPrivateFieldLooseBase(this,iu)[iu](e);if(s===null){return false}babelHelpers.classPrivateFieldLooseBase(this,Xb)[Xb]=s;babelHelpers.classPrivateFieldLooseBase(this,hu)[hu](s,e);e.preventDefault();return true}function Cu(e){var t;if(babelHelpers.classPrivateFieldLooseBase(this,Jb)[Jb]===false){return false}const s=e.dataTransfer.types.includes("Files");const i=((t=e.dataTransfer)==null?void 0:t.getData(Wb))||"";if(s||!(e.target instanceof HTMLElement)||!F.Type.isStringFilled(i)){return false}const r=L.$getNodeByKey(i);if(!r||!(e.target instanceof HTMLElement)){return false}const a=babelHelpers.classPrivateFieldLooseBase(this,iu)[iu](e)||babelHelpers.classPrivateFieldLooseBase(this,Xb)[Xb];if(!a){return false}const o=L.$getNearestNodeFromDOMNode(a);if(!o){return false}F.Event.unbind(document.body,"drop",babelHelpers.classPrivateFieldLooseBase(this,qb)[qb]);F.Event.unbind(document.body,"dragover",babelHelpers.classPrivateFieldLooseBase(this,Qb)[Qb]);if(o===r){return true}const{top:l,height:n}=a.getBoundingClientRect();const d=e.clientY-l>n/2;if(d){o.insertAfter(r)}else{o.insertBefore(r)}babelHelpers.classPrivateFieldLooseBase(this,ou)[ou](null);return true}function Ou(e,t){const{top:s,height:i}=e.getBoundingClientRect();const r=window.getComputedStyle(e);const a=F.Dom.getRelativePosition(e,e.offsetParent);let o=a.top;const l=t.clientY-s>i/2;if(l){o+=i+parseFloat(r.marginBottom)*1.5}else{o+=parseFloat(r.marginTop)/2}const n=2;const d=16;const c=o-n;F.Dom.style(this.getDropLine(),{opacity:.4,left:`${d}px`,right:`${d}px`,transform:`translateY(${c}px)`})}function Tu(){F.Dom.style(this.getDropLine(),{opacity:0,transform:"translate(-10000px, -10000px)"})}var Eu=Object.freeze({BlockToolbarPlugin:uu});let Nu=e=>e,_u;var Mu=babelHelpers.classPrivateFieldLooseKey("container");class Du extends re{constructor(...e){super(...e);Object.defineProperty(this,Mu,{writable:true,value:null})}getContainer(){if(babelHelpers.classPrivateFieldLooseBase(this,Mu)[Mu]===null){babelHelpers.classPrivateFieldLooseBase(this,Mu)[Mu]=F.Tag.render(_u||(_u=Nu`<span class="ui-text-editor-toolbar-separator"></span>`))}return babelHelpers.classPrivateFieldLooseBase(this,Mu)[Mu]}render(){return this.getContainer()}}let Su=e=>e,Ru,Iu,xu;var wu=babelHelpers.classPrivateFieldLooseKey("textEditor");var Au=babelHelpers.classPrivateFieldLooseKey("items");var $u=babelHelpers.classPrivateFieldLooseKey("rendered");var Ku=babelHelpers.classPrivateFieldLooseKey("moreBtn");var ju=babelHelpers.classPrivateFieldLooseKey("refs");var ku=babelHelpers.classPrivateFieldLooseKey("resizeObserver");var Uu=babelHelpers.classPrivateFieldLooseKey("timeoutId");var Wu=babelHelpers.classPrivateFieldLooseKey("removeListeners");var Yu=babelHelpers.classPrivateFieldLooseKey("registerListeners");var zu=babelHelpers.classPrivateFieldLooseKey("fillFromOptions");var Xu=babelHelpers.classPrivateFieldLooseKey("handleResize");var Gu=babelHelpers.classPrivateFieldLooseKey("getSelectionBlockTypes");var Vu=babelHelpers.classPrivateFieldLooseKey("getBlockType");class Ju{constructor(e,t){Object.defineProperty(this,Vu,{value:tp});Object.defineProperty(this,Gu,{value:ep});Object.defineProperty(this,Xu,{value:Zu});Object.defineProperty(this,zu,{value:Qu});Object.defineProperty(this,Yu,{value:qu});Object.defineProperty(this,wu,{writable:true,value:null});Object.defineProperty(this,Au,{writable:true,value:[]});Object.defineProperty(this,$u,{writable:true,value:false});Object.defineProperty(this,Ku,{writable:true,value:null});Object.defineProperty(this,ju,{writable:true,value:new g.MemoryCache});Object.defineProperty(this,ku,{writable:true,value:null});Object.defineProperty(this,Uu,{writable:true,value:null});Object.defineProperty(this,Wu,{writable:true,value:null});babelHelpers.classPrivateFieldLooseBase(this,wu)[wu]=e;const s=F.Type.isArray(t)?t:[];babelHelpers.classPrivateFieldLooseBase(this,zu)[zu](s);if(babelHelpers.classPrivateFieldLooseBase(this,Au)[Au].length>0){babelHelpers.classPrivateFieldLooseBase(this,Wu)[Wu]=babelHelpers.classPrivateFieldLooseBase(this,Yu)[Yu]();babelHelpers.classPrivateFieldLooseBase(this,ku)[ku]=new ResizeObserver(babelHelpers.classPrivateFieldLooseBase(this,Xu)[Xu].bind(this))}}renderTo(e){if(this.isRendered()){return}if(F.Type.isElementNode(e)){babelHelpers.classPrivateFieldLooseBase(this,Au)[Au].forEach((e=>{F.Dom.append(e.render(),this.getItemsContainer())}));F.Dom.append(this.getContainer(),e);if(babelHelpers.classPrivateFieldLooseBase(this,ku)[ku]!==null){babelHelpers.classPrivateFieldLooseBase(this,ku)[ku].observe(this.getContainer())}babelHelpers.classPrivateFieldLooseBase(this,$u)[$u]=true}}isEmpty(){return babelHelpers.classPrivateFieldLooseBase(this,Au)[Au].length===0}getContainer(){return babelHelpers.classPrivateFieldLooseBase(this,ju)[ju].remember("container",(()=>F.Tag.render(Ru||(Ru=Su`
				<div class="ui-text-editor-toolbar-container">
					${0}
					${0}
				</div>
			`),this.getItemsContainer(),this.getMoreBtnContainer())))}getItemsContainer(){return babelHelpers.classPrivateFieldLooseBase(this,ju)[ju].remember("items-container",(()=>F.Tag.render(Iu||(Iu=Su`
				<div class="ui-text-editor-toolbar-items"></div>
			`))))}getMoreBtnContainer(){return babelHelpers.classPrivateFieldLooseBase(this,ju)[ju].remember("more-btn-container",(()=>F.Tag.render(xu||(xu=Su`
				<div class="ui-text-editor-toolbar-more-btn">
				${0}
				</div>
			`),this.getMoreBtn().render())))}getMoreBtn(){if(babelHelpers.classPrivateFieldLooseBase(this,Ku)[Ku]===null){const e=()=>{F.Event.unbind(this.getItemsContainer(),"transitionend",e);F.Dom.style(this.getItemsContainer(),{height:null});F.Dom.removeClass(this.getItemsContainer(),"--animating")};babelHelpers.classPrivateFieldLooseBase(this,Ku)[Ku]=new ge;babelHelpers.classPrivateFieldLooseBase(this,Ku)[Ku].setContent('<span class="ui-text-editor-toolbar-more-btn-icon"></span>');babelHelpers.classPrivateFieldLooseBase(this,Ku)[Ku].subscribe("onClick",(()=>{F.Event.unbind(this.getItemsContainer(),"transitionend",e);if(F.Dom.hasClass(this.getContainer(),"--expanded")){F.Dom.style(this.getItemsContainer(),{height:`${this.getItemsContainer().scrollHeight}px`});requestAnimationFrame((()=>{F.Dom.removeClass(this.getContainer(),"--expanded");F.Dom.addClass(this.getItemsContainer(),"--animating");F.Dom.style(this.getItemsContainer(),{height:null})}))}else{F.Dom.addClass(this.getItemsContainer(),"--animating");F.Dom.style(this.getItemsContainer(),{height:`${this.getItemsContainer().scrollHeight}px`});F.Dom.addClass(this.getContainer(),"--expanded")}F.Event.bind(this.getItemsContainer(),"transitionend",e)}))}return babelHelpers.classPrivateFieldLooseBase(this,Ku)[Ku]}getItems(){return babelHelpers.classPrivateFieldLooseBase(this,Au)[Au]}isRendered(){return babelHelpers.classPrivateFieldLooseBase(this,$u)[$u]}destroy(){if(babelHelpers.classPrivateFieldLooseBase(this,Wu)[Wu]!==null){babelHelpers.classPrivateFieldLooseBase(this,Wu)[Wu]()}if(babelHelpers.classPrivateFieldLooseBase(this,ku)[ku]!==null){babelHelpers.classPrivateFieldLooseBase(this,ku)[ku].disconnect();babelHelpers.classPrivateFieldLooseBase(this,ku)[ku]=null}if(this.isRendered()){F.Dom.remove(this.getContainer())}if(babelHelpers.classPrivateFieldLooseBase(this,Uu)[Uu]){clearTimeout(babelHelpers.classPrivateFieldLooseBase(this,Uu)[Uu])}babelHelpers.classPrivateFieldLooseBase(this,Au)[Au]=null;babelHelpers.classPrivateFieldLooseBase(this,ju)[ju]=null}update(){babelHelpers.classPrivateFieldLooseBase(this,wu)[wu].getEditorState().read((()=>{let e=L.$getSelection();if(!L.$isRangeSelection(e)){e=null}let t=null;if(e!==null){t=y.$findMatchingParent(e.anchor.getNode(),(e=>(e.__flags&E)!==0))}const s=e===null?new Set:babelHelpers.classPrivateFieldLooseBase(this,Gu)[Gu](e);const i=!babelHelpers.classPrivateFieldLooseBase(this,wu)[wu].isEditable();babelHelpers.classPrivateFieldLooseBase(this,Au)[Au].forEach((r=>{if(!(r instanceof ge)){return}if(r.hasOwnDisableCallback()){r.setDisabled(r.invokeDisableCallback())}else if(i){r.disable()}else if(t!==null&&r.shouldDisableInsideUnformatted()){r.disable()}else{r.enable()}if(r.isDisabled()){r.setActive(false)}else if(r.hasFormat()){const t=r.getFormat();r.setActive(e===null?false:e.hasFormat(t))}else if(r.getBlockType()!==null){r.setActive(s.has(r.getBlockType()))}}))}))}reset(){babelHelpers.classPrivateFieldLooseBase(this,Au)[Au].forEach((e=>{if(e instanceof ge){e.setActive(false)}}))}}function qu(){return y.mergeRegister(babelHelpers.classPrivateFieldLooseBase(this,wu)[wu].registerCommand(L.SELECTION_CHANGE_COMMAND,(()=>{this.update();return false}),L.COMMAND_PRIORITY_CRITICAL),babelHelpers.classPrivateFieldLooseBase(this,wu)[wu].registerCommand(L.FOCUS_COMMAND,(()=>{if(babelHelpers.classPrivateFieldLooseBase(this,Uu)[Uu]){clearTimeout(babelHelpers.classPrivateFieldLooseBase(this,Uu)[Uu]);babelHelpers.classPrivateFieldLooseBase(this,Uu)[Uu]=null}return false}),L.COMMAND_PRIORITY_CRITICAL),babelHelpers.classPrivateFieldLooseBase(this,wu)[wu].registerCommand(L.BLUR_COMMAND,(()=>{if(babelHelpers.classPrivateFieldLooseBase(this,Uu)[Uu]){clearTimeout(babelHelpers.classPrivateFieldLooseBase(this,Uu)[Uu])}babelHelpers.classPrivateFieldLooseBase(this,Uu)[Uu]=setTimeout((()=>{const e=document.activeElement;const t=babelHelpers.classPrivateFieldLooseBase(this,wu)[wu].getScrollerContainer();if(e===null||!t.contains(e)){this.reset()}}),400);return false}),L.COMMAND_PRIORITY_CRITICAL),babelHelpers.classPrivateFieldLooseBase(this,wu)[wu].registerUpdateListener((()=>{this.update()})),babelHelpers.classPrivateFieldLooseBase(this,wu)[wu].registerEditableListener((()=>{this.update()})))}function Qu(e){e.forEach((e=>{if(e==="|"){babelHelpers.classPrivateFieldLooseBase(this,Au)[Au].push(new Du)}else{const t=babelHelpers.classPrivateFieldLooseBase(this,wu)[wu].getComponentRegistry().create(e);if(t===null){console.warn(`TextEditor Toolbar: "${e}" component doesn't exist.`)}else{babelHelpers.classPrivateFieldLooseBase(this,Au)[Au].push(t)}}}))}function Zu(e){if(this.getContainer().offsetWidth===0||F.Dom.hasClass(this.getItemsContainer(),"--animating")){return}const t=babelHelpers.classPrivateFieldLooseBase(this,Au)[Au].at(-1);if(!t||t.getContainer().offsetTop>=t.getContainer().offsetHeight){F.Dom.addClass(this.getContainer(),"--overflowed")}else{F.Dom.removeClass(this.getContainer(),["--overflowed","--expanded"])}}function ep(e){const t=e.anchor.getNode();const s=new Set;let i=t;while(i!==L.$getRoot()&&i!==null){const e=babelHelpers.classPrivateFieldLooseBase(this,Vu)[Vu](i);s.add(e);i=i.getParent()}return s}function tp(e){if(f.$isListNode(e)){const t=e;const s=y.$getNearestNodeOfType(t,f.ListNode);return s?s.getListType():t.getListType()}if(P.$isLinkNode(e)||P.$isAutoLinkNode(e)){return"link"}if(It(e)){return"code"}return e.getType()}let sp=e=>e,ip;var rp=babelHelpers.classPrivateFieldLooseKey("popup");var ap=babelHelpers.classPrivateFieldLooseKey("toolbar");var op=babelHelpers.classPrivateFieldLooseKey("showDebounced");var lp=babelHelpers.classPrivateFieldLooseKey("onEditorScroll");var np=babelHelpers.classPrivateFieldLooseKey("registerListeners");var dp=babelHelpers.classPrivateFieldLooseKey("show");var cp=babelHelpers.classPrivateFieldLooseKey("adjustDialogPosition");var hp=babelHelpers.classPrivateFieldLooseKey("initDialogPosition");var bp=babelHelpers.classPrivateFieldLooseKey("handleEditorScroll");var up=babelHelpers.classPrivateFieldLooseKey("shouldShowDialog");class pp extends ie{constructor(e){super(e);Object.defineProperty(this,up,{value:Lp});Object.defineProperty(this,bp,{value:mp});Object.defineProperty(this,hp,{value:Pp});Object.defineProperty(this,cp,{value:fp});Object.defineProperty(this,dp,{value:vp});Object.defineProperty(this,np,{value:gp});Object.defineProperty(this,rp,{writable:true,value:null});Object.defineProperty(this,ap,{writable:true,value:null});Object.defineProperty(this,op,{writable:true,value:null});Object.defineProperty(this,lp,{writable:true,value:babelHelpers.classPrivateFieldLooseBase(this,bp)[bp].bind(this)});babelHelpers.classPrivateFieldLooseBase(this,op)[op]=F.Runtime.debounce((()=>{this.getEditor().update((()=>{if(babelHelpers.classPrivateFieldLooseBase(this,up)[up]()){babelHelpers.classPrivateFieldLooseBase(this,dp)[dp]()}}))}),700)}static getName(){return"FloatingToolbar"}afterInit(){const e=this.getEditor().getOption("floatingToolbar",[]);babelHelpers.classPrivateFieldLooseBase(this,ap)[ap]=new Ju(this.getEditor(),e);if(!babelHelpers.classPrivateFieldLooseBase(this,ap)[ap].isEmpty()){this.cleanUpRegister(babelHelpers.classPrivateFieldLooseBase(this,np)[np]())}}update(){if(babelHelpers.classPrivateFieldLooseBase(this,up)[up]()){if(this.getPopup().isShown()){babelHelpers.classPrivateFieldLooseBase(this,dp)[dp]()}else{babelHelpers.classPrivateFieldLooseBase(this,op)[op]()}}else{this.getPopup().close()}}getPopup(){if(babelHelpers.classPrivateFieldLooseBase(this,rp)[rp]===null){const e=F.Tag.render(ip||(ip=sp`<div class="ui-text-editor-floating-toolbar"></div>`));babelHelpers.classPrivateFieldLooseBase(this,rp)[rp]=new p.Popup({closeByEsc:true,targetContainer:document.body,autoHide:true,content:e,autoHideHandler:e=>{let t=true;const s=window.getSelection();if(s.isCollapsed){return true}this.getEditor().update((()=>{const e=L.$getSelection();t=e===null||e.isCollapsed()}));return t},events:{onShow:()=>{if(babelHelpers.classPrivateFieldLooseBase(this,cp)[cp]()){F.Event.bind(this.getEditor().getScrollerContainer(),"scroll",babelHelpers.classPrivateFieldLooseBase(this,lp)[lp])}},onClose:()=>{F.Event.unbind(this.getEditor().getScrollerContainer(),"scroll",babelHelpers.classPrivateFieldLooseBase(this,lp)[lp]);sa(this.getPopup())}}});babelHelpers.classPrivateFieldLooseBase(this,ap)[ap].renderTo(e)}return babelHelpers.classPrivateFieldLooseBase(this,rp)[rp]}hide(){if(babelHelpers.classPrivateFieldLooseBase(this,rp)[rp]===null){return}this.getPopup().close()}destroy(){super.destroy();if(babelHelpers.classPrivateFieldLooseBase(this,rp)[rp]!==null){babelHelpers.classPrivateFieldLooseBase(this,rp)[rp].destroy();babelHelpers.classPrivateFieldLooseBase(this,rp)[rp]=null}babelHelpers.classPrivateFieldLooseBase(this,ap)[ap].destroy();babelHelpers.classPrivateFieldLooseBase(this,ap)[ap]=null}}function gp(){return y.mergeRegister(this.getEditor().registerCommand(L.SELECTION_CHANGE_COMMAND,(()=>{this.update();return false}),L.COMMAND_PRIORITY_CRITICAL),this.getEditor().registerUpdateListener((({editorState:e})=>{e.read((()=>{this.update()}))})),this.getEditor().registerCommand(H,(()=>{this.hide();return false}),L.COMMAND_PRIORITY_LOW))}function vp(){this.getPopup().show();sa(this.getPopup());babelHelpers.classPrivateFieldLooseBase(this,cp)[cp]()}function fp(){return ta(this.getPopup(),this.getEditor(),babelHelpers.classPrivateFieldLooseBase(this,hp)[hp])}function Pp(e){const{isBackward:t,isMultiline:s}=e;return t||!s?"top":"bottom"}function mp(){this.getEditor().update((()=>{babelHelpers.classPrivateFieldLooseBase(this,cp)[cp]()}))}function Lp(){if(this.getEditor().isComposing()||!this.getEditor().isEditable()){return false}const e=L.$getSelection();if(!L.$isRangeSelection(e)||e.isCollapsed()){return false}const t=window.getSelection();if(t===null||t.isCollapsed){return false}const s=this.getEditor().getScrollerContainer();if(!s.contains(t.anchorNode)){return false}const i=y.$findMatchingParent(e.anchor.getNode(),(e=>(e.__flags&E)!==0));if(i||e.getTextContent()===""){return false}const r=e.getTextContent().replaceAll("\n","");if(!e.isCollapsed()&&r===""){return false}const a=this.getEditor().dispatchCommand(B);if(a){return false}const o=w(e);return L.$isTextNode(o)}var yp=Object.freeze({FloatingToolbarPlugin:pp});const Fp=L.createCommand("TOGGLE_TOOLBAR_COMMAND");const Hp=L.createCommand("SHOW_TOOLBAR_COMMAND");const Bp=L.createCommand("HIDE_TOOLBAR_COMMAND");var Cp=babelHelpers.classPrivateFieldLooseKey("toolbar");var Op=babelHelpers.classPrivateFieldLooseKey("registerCommands");class Tp extends ie{constructor(...e){super(...e);Object.defineProperty(this,Op,{value:Ep});Object.defineProperty(this,Cp,{writable:true,value:null})}static getName(){return"Toolbar"}getToolbar(){return babelHelpers.classPrivateFieldLooseBase(this,Cp)[Cp]}isRendered(){return babelHelpers.classPrivateFieldLooseBase(this,Cp)[Cp]!==null&&babelHelpers.classPrivateFieldLooseBase(this,Cp)[Cp].isRendered()}show(){if(this.isRendered()){F.Dom.removeClass(this.getEditor().getToolbarContainer(),"--hidden")}}hide(){if(this.isRendered()){F.Dom.addClass(this.getEditor().getToolbarContainer(),"--hidden")}}isShown(){return this.isRendered()&&!F.Dom.hasClass(this.getEditor().getToolbarContainer(),"--hidden")}toggle(){if(this.isShown()){this.hide()}else{this.show()}}afterInit(){babelHelpers.classPrivateFieldLooseBase(this,Cp)[Cp]=new Ju(this.getEditor(),this.getEditor().getOption("toolbar"));if(!babelHelpers.classPrivateFieldLooseBase(this,Cp)[Cp].isEmpty()){babelHelpers.classPrivateFieldLooseBase(this,Op)[Op]();babelHelpers.classPrivateFieldLooseBase(this,Cp)[Cp].renderTo(this.getEditor().getToolbarContainer());const e=this.getEditor().getOption("hideToolbar",false);if(e){this.hide()}}}destroy(){super.destroy();babelHelpers.classPrivateFieldLooseBase(this,Cp)[Cp].destroy()}}function Ep(){this.cleanUpRegister(this.getEditor().registerCommand(Fp,(()=>{this.toggle();return true}),L.COMMAND_PRIORITY_LOW),this.getEditor().registerCommand(Hp,(()=>{this.show();return true}),L.COMMAND_PRIORITY_LOW),this.getEditor().registerCommand(Bp,(()=>{this.hide();return true}),L.COMMAND_PRIORITY_LOW))}var Np=Object.freeze({TOGGLE_TOOLBAR_COMMAND:Fp,SHOW_TOOLBAR_COMMAND:Hp,HIDE_TOOLBAR_COMMAND:Bp,ToolbarPlugin:Tp});let _p=e=>e,Mp;var Dp=babelHelpers.classPrivateFieldLooseKey("placeholder");var Sp=babelHelpers.classPrivateFieldLooseKey("placeholderNode");var Rp=babelHelpers.classPrivateFieldLooseKey("paragraphPlaceholder");var Ip=babelHelpers.classPrivateFieldLooseKey("registerPlaceholderListeners");var xp=babelHelpers.classPrivateFieldLooseKey("togglePlaceholder");var wp=babelHelpers.classPrivateFieldLooseKey("hasFocus");var Ap=babelHelpers.classPrivateFieldLooseKey("hidePlaceholder");var $p=babelHelpers.classPrivateFieldLooseKey("registerParagraphListeners");class Kp extends ie{constructor(...e){super(...e);Object.defineProperty(this,$p,{value:Yp});Object.defineProperty(this,Ap,{value:Wp});Object.defineProperty(this,wp,{value:Up});Object.defineProperty(this,xp,{value:kp});Object.defineProperty(this,Ip,{value:jp});Object.defineProperty(this,Dp,{writable:true,value:null});Object.defineProperty(this,Sp,{writable:true,value:null});Object.defineProperty(this,Rp,{writable:true,value:null})}afterInit(){const e=this.getEditor().getOption("placeholder");if(F.Type.isStringFilled(e)){babelHelpers.classPrivateFieldLooseBase(this,Dp)[Dp]=e;babelHelpers.classPrivateFieldLooseBase(this,Sp)[Sp]=F.Tag.render(Mp||(Mp=_p`
				<div class="ui-text-editor-placeholder">${0}</div>
			`),F.Text.encode(babelHelpers.classPrivateFieldLooseBase(this,Dp)[Dp]));F.Dom.append(babelHelpers.classPrivateFieldLooseBase(this,Sp)[Sp],this.getEditor().getScrollerContainer());babelHelpers.classPrivateFieldLooseBase(this,Ip)[Ip]()}let t=this.getEditor().getOption("paragraphPlaceholder");if(F.Type.isStringFilled(t)){if(t==="auto"){const e=this.getEditor().getPlugin("Copilot");const s=e!==null&&e.shouldTriggerBySpace();const i=this.getEditor().getPlugin("Mention");const r=i!==null&&i.shouldTriggerByAtSign();if(s&&r){t=F.Loc.getMessage("TEXT_EDITOR_PLACEHOLDER_MENTION_COPILOT")}else if(s){t=F.Loc.getMessage("TEXT_EDITOR_PLACEHOLDER_COPILOT")}else if(r){t=F.Loc.getMessage("TEXT_EDITOR_PLACEHOLDER_MENTION")}}if(t!=="auto"){babelHelpers.classPrivateFieldLooseBase(this,Rp)[Rp]=t;babelHelpers.classPrivateFieldLooseBase(this,$p)[$p]()}}}static getName(){return"Placeholder"}}function jp(){this.cleanUpRegister(this.getEditor().registerUpdateListener((()=>{this.getEditor().getEditorState().read((()=>{babelHelpers.classPrivateFieldLooseBase(this,xp)[xp]()}))})))}function kp(){if(babelHelpers.classPrivateFieldLooseBase(this,Dp)[Dp]===null){return}let e=m.$canShowPlaceholder(this.getLexicalEditor().isComposing());if(e&&babelHelpers.classPrivateFieldLooseBase(this,Rp)[Rp]!==null&&babelHelpers.classPrivateFieldLooseBase(this,wp)[wp]()){e=false}if(e){F.Dom.addClass(babelHelpers.classPrivateFieldLooseBase(this,Sp)[Sp],"--shown")}else{F.Dom.removeClass(babelHelpers.classPrivateFieldLooseBase(this,Sp)[Sp],"--shown")}}function Up(){const e=document.activeElement;const t=this.getEditor().getRootElement();return t!==null&&e!==null&&t.contains(e)}function Wp(){if(babelHelpers.classPrivateFieldLooseBase(this,Sp)[Sp]!==null){F.Dom.removeClass(babelHelpers.classPrivateFieldLooseBase(this,Sp)[Sp],"--shown")}}function Yp(){let e=null;const t=()=>{if(e){const t=this.getEditor().getElementByKey(e.getKey());if(t){delete t.dataset.placeholder}}};this.cleanUpRegister(this.getEditor().registerCommand(L.SELECTION_CHANGE_COMMAND,(()=>{if(!this.getEditor().isEditable()){return false}const s=L.$getSelection();let i=null;if(L.$isRangeSelection(s)&&s.isCollapsed()){const e=s.anchor.getNode();if(L.$isParagraphNode(e)&&L.$isRootNode(e.getParent())&&e.isEmpty()){const t=this.getEditor().getElementByKey(e.getKey());if(t&&babelHelpers.classPrivateFieldLooseBase(this,wp)[wp]()){t.dataset.placeholder=babelHelpers.classPrivateFieldLooseBase(this,Rp)[Rp];i=e;babelHelpers.classPrivateFieldLooseBase(this,Ap)[Ap]()}}}if(e&&e!==i){t()}e=i;return false}),L.COMMAND_PRIORITY_CRITICAL),this.getEditor().registerCommand(L.PASTE_COMMAND,(()=>{t();return false}),L.COMMAND_PRIORITY_CRITICAL),this.getEditor().registerCommand(L.BLUR_COMMAND,(()=>{t();babelHelpers.classPrivateFieldLooseBase(this,xp)[xp]();return false}),L.COMMAND_PRIORITY_CRITICAL))}let zp=e=>e,Xp,Gp,Vp,Jp,qp,Qp,Zp,eg,tg,sg;const ig={COLLAPSED:"collapsed",COLLAPSING:"collapsing",EXPANDED:"expanded",EXPANDING:"expanding"};var rg=babelHelpers.classPrivateFieldLooseKey("lexicalEditor");var ag=babelHelpers.classPrivateFieldLooseKey("componentRegistry");var og=babelHelpers.classPrivateFieldLooseKey("refs");var lg=babelHelpers.classPrivateFieldLooseKey("options");var ng=babelHelpers.classPrivateFieldLooseKey("plugins");var dg=babelHelpers.classPrivateFieldLooseKey("newLineMode");var cg=babelHelpers.classPrivateFieldLooseKey("bbcodeScheme");var hg=babelHelpers.classPrivateFieldLooseKey("schemeValidation");var bg=babelHelpers.classPrivateFieldLooseKey("bbcodeImportMap");var ug=babelHelpers.classPrivateFieldLooseKey("bbcodeExportMap");var pg=babelHelpers.classPrivateFieldLooseKey("themeClasses");var gg=babelHelpers.classPrivateFieldLooseKey("decoratorNodes");var vg=babelHelpers.classPrivateFieldLooseKey("decoratorComponents");var fg=babelHelpers.classPrivateFieldLooseKey("removeListeners");var Pg=babelHelpers.classPrivateFieldLooseKey("highlightContainer");var mg=babelHelpers.classPrivateFieldLooseKey("autoFocus");var Lg=babelHelpers.classPrivateFieldLooseKey("minHeight");var yg=babelHelpers.classPrivateFieldLooseKey("maxHeight");var Fg=babelHelpers.classPrivateFieldLooseKey("collapsingMode");var Hg=babelHelpers.classPrivateFieldLooseKey("collapsingState");var Bg=babelHelpers.classPrivateFieldLooseKey("collapsingTransitionEnd");var Cg=babelHelpers.classPrivateFieldLooseKey("paragraphHeight");var Og=babelHelpers.classPrivateFieldLooseKey("resizeObserver");var Tg=babelHelpers.classPrivateFieldLooseKey("destroying");var Eg=babelHelpers.classPrivateFieldLooseKey("rendered");var Ng=babelHelpers.classPrivateFieldLooseKey("prevEmptyStatus");var _g=babelHelpers.classPrivateFieldLooseKey("initEditorState");var Mg=babelHelpers.classPrivateFieldLooseKey("initDecorateNodes");var Dg=babelHelpers.classPrivateFieldLooseKey("registerCommands");var Sg=babelHelpers.classPrivateFieldLooseKey("createNamespace");var Rg=babelHelpers.classPrivateFieldLooseKey("initBBCodeImportMap");var Ig=babelHelpers.classPrivateFieldLooseKey("initBBCodeExportMap");var xg=babelHelpers.classPrivateFieldLooseKey("initBBCodeScheme");var wg=babelHelpers.classPrivateFieldLooseKey("initCollapsingMode");var Ag=babelHelpers.classPrivateFieldLooseKey("collapse");var $g=babelHelpers.classPrivateFieldLooseKey("handleCollapsingTransition");class Kg extends b.EventEmitter{constructor(e){super();Object.defineProperty(this,$g,{value:Jg});Object.defineProperty(this,Ag,{value:Vg});Object.defineProperty(this,wg,{value:Gg});Object.defineProperty(this,xg,{value:Xg});Object.defineProperty(this,Ig,{value:zg});Object.defineProperty(this,Rg,{value:Yg});Object.defineProperty(this,Sg,{value:Wg});Object.defineProperty(this,Dg,{value:Ug});Object.defineProperty(this,Mg,{value:kg});Object.defineProperty(this,_g,{value:jg});Object.defineProperty(this,rg,{writable:true,value:null});Object.defineProperty(this,ag,{writable:true,value:new zn});Object.defineProperty(this,og,{writable:true,value:new F.Cache.MemoryCache});Object.defineProperty(this,lg,{writable:true,value:null});Object.defineProperty(this,ng,{writable:true,value:null});Object.defineProperty(this,dg,{writable:true,value:N.MIXED});Object.defineProperty(this,cg,{writable:true,value:null});Object.defineProperty(this,hg,{writable:true,value:null});Object.defineProperty(this,bg,{writable:true,value:void 0});Object.defineProperty(this,ug,{writable:true,value:void 0});Object.defineProperty(this,pg,{writable:true,value:{}});Object.defineProperty(this,gg,{writable:true,value:new Set});Object.defineProperty(this,vg,{writable:true,value:new Map});Object.defineProperty(this,fg,{writable:true,value:null});Object.defineProperty(this,Pg,{writable:true,value:F.Tag.render(Xp||(Xp=zp`<div class="ui-text-editor-selection-highlighting"></div>`))});Object.defineProperty(this,mg,{writable:true,value:false});Object.defineProperty(this,Lg,{writable:true,value:null});Object.defineProperty(this,yg,{writable:true,value:null});Object.defineProperty(this,Fg,{writable:true,value:false});Object.defineProperty(this,Hg,{writable:true,value:ig.EXPANDED});Object.defineProperty(this,Bg,{writable:true,value:babelHelpers.classPrivateFieldLooseBase(this,$g)[$g].bind(this)});Object.defineProperty(this,Cg,{writable:true,value:null});Object.defineProperty(this,Og,{writable:true,value:null});Object.defineProperty(this,Tg,{writable:true,value:false});Object.defineProperty(this,Eg,{writable:true,value:false});Object.defineProperty(this,Ng,{writable:true,value:true});this.setEventNamespace("BX.UI.TextEditor.Editor");const t=this.constructor.getDefaultOptions();const s=F.Type.isPlainObject(e)?e:{};babelHelpers.classPrivateFieldLooseBase(this,lg)[lg]=new l.SettingsCollection({...t,...s});const i=[...this.constructor.getBuiltinPlugins()];const r=babelHelpers.classPrivateFieldLooseBase(this,lg)[lg].get("plugins",i);const a=babelHelpers.classPrivateFieldLooseBase(this,lg)[lg].get("extraPlugins",[]);const o=babelHelpers.classPrivateFieldLooseBase(this,lg)[lg].get("removePlugins",[]);const n=babelHelpers.classPrivateFieldLooseBase(this,lg)[lg].get("newLineMode");if([N.LINE_BREAK,N.PARAGRAPH].includes(n)){babelHelpers.classPrivateFieldLooseBase(this,dg)[dg]=n}babelHelpers.classPrivateFieldLooseBase(this,pg)[pg]=An;babelHelpers.classPrivateFieldLooseBase(this,ng)[ng]=new Un(i,[...r,...a],o);const d=babelHelpers.classPrivateFieldLooseBase(this,ng)[ng].getConstructors();const c=d.map((e=>e.getNodes(this)));babelHelpers.classPrivateFieldLooseBase(this,rg)[rg]=L.createEditor({namespace:F.Type.isStringFilled(s.namespace)?s.namespace:babelHelpers.classPrivateFieldLooseBase(this,Sg)[Sg](d),nodes:c.flat(),onError:e=>{console.error(e)},theme:babelHelpers.classPrivateFieldLooseBase(this,pg)[pg],editable:babelHelpers.classPrivateFieldLooseBase(this,lg)[lg].get("editable")!==false});this.setMinHeight(s.minHeight);this.setMaxHeight(s.maxHeight);this.setAutoFocus(s.autoFocus);this.setVisualOptions(s.visualOptions);babelHelpers.classPrivateFieldLooseBase(this,fg)[fg]=y.mergeRegister(babelHelpers.classPrivateFieldLooseBase(this,Dg)[Dg](),babelHelpers.classPrivateFieldLooseBase(this,Mg)[Mg](c.flat()));babelHelpers.classPrivateFieldLooseBase(this,ng)[ng].init(this);babelHelpers.classPrivateFieldLooseBase(this,bg)[bg]=babelHelpers.classPrivateFieldLooseBase(this,Rg)[Rg]();babelHelpers.classPrivateFieldLooseBase(this,ug)[ug]=babelHelpers.classPrivateFieldLooseBase(this,Ig)[Ig]();babelHelpers.classPrivateFieldLooseBase(this,cg)[cg]=babelHelpers.classPrivateFieldLooseBase(this,xg)[xg]();babelHelpers.classPrivateFieldLooseBase(this,hg)[hg]=new Zn(this);this.subscribeFromOptions(s.events)}static getBuiltinPlugins(){return[sd,Ht,ad,ld,yd,hd,vd,Td,ih,os,_e,hh,No,fc,$c,_a,bn,bl,Ve,Ah,Xh,yb,wb,uu,pp,Tp,Kp,Fr]}static getDefaultOptions(){return{}}getComponentRegistry(){return babelHelpers.classPrivateFieldLooseBase(this,ag)[ag]}getOptions(){return babelHelpers.classPrivateFieldLooseBase(this,lg)[lg]}getOption(e,t=null){return babelHelpers.classPrivateFieldLooseBase(this,lg)[lg].get(e,t)}getThemeClasses(){return babelHelpers.classPrivateFieldLooseBase(this,pg)[pg]}getThemeClass(e){const t=babelHelpers.classPrivateFieldLooseBase(this,pg)[pg][e];if(t!==undefined){return t}return""}getNewLineMode(){return babelHelpers.classPrivateFieldLooseBase(this,dg)[dg]}getBBCodeScheme(){return babelHelpers.classPrivateFieldLooseBase(this,cg)[cg]}getSchemeValidation(){return babelHelpers.classPrivateFieldLooseBase(this,hg)[hg]}setText(e,t){if(F.Type.isString(e)){const s={discrete:F.Type.isPlainObject(t)&&t.discrete===true};babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].update((()=>{const t=K(e,this);const s=L.$getRoot();s.clear();s.append(...t);L.$setSelection(null)}),s)}}clear(e){const t={discrete:F.Type.isPlainObject(e)&&e.discrete===true};babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].update((()=>{const e=L.$getRoot();const t=L.$createParagraphNode();e.clear();e.append(t);L.$setSelection(null)}),t)}clearHistory(){this.dispatchCommand(L.CLEAR_HISTORY_COMMAND)}getText(){return babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].getEditorState().read((()=>{const e=V(L.$getRoot(),this);return e.toString()}))}isEmpty(e=true){return babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].getEditorState().read((()=>wn(e)))}setAutoFocus(e){if(F.Type.isBoolean(e)){babelHelpers.classPrivateFieldLooseBase(this,mg)[mg]=e}}hasAutoFocus(){return babelHelpers.classPrivateFieldLooseBase(this,mg)[mg]}setMinHeight(e){if(F.Type.isNumber(e)&&e>0||e===null){const t=babelHelpers.classPrivateFieldLooseBase(this,Lg)[Lg]!==e;babelHelpers.classPrivateFieldLooseBase(this,Lg)[Lg]=e;if(t){F.Dom.style(this.getScrollerContainer(),"--ui-text-editor-min-height",e>0?`${e}px`:null)}}}getMinHeight(){return babelHelpers.classPrivateFieldLooseBase(this,Lg)[Lg]}setMaxHeight(e){if(F.Type.isNumber(e)&&e>0||e===null){const t=babelHelpers.classPrivateFieldLooseBase(this,yg)[yg]!==e;babelHelpers.classPrivateFieldLooseBase(this,yg)[yg]=e;if(t){F.Dom.style(this.getScrollerContainer(),"--ui-text-editor-max-height",e>0?`${e}px`:null)}}}getMaxHeight(){return babelHelpers.classPrivateFieldLooseBase(this,yg)[yg]}setVisualOptions(e){if(!F.Type.isPlainObject(e)){return}for(const[t,s]of Object.entries(e)){const e=F.Text.toKebabCase(t);F.Dom.style(this.getRootContainer(),`--ui-text-editor-${e}`,s)}}isCollapsingModeEnabled(){return babelHelpers.classPrivateFieldLooseBase(this,Fg)[Fg]}isCollapsed(){return babelHelpers.classPrivateFieldLooseBase(this,Hg)[Hg]===ig.COLLAPSED}collapse(e=true){babelHelpers.classPrivateFieldLooseBase(this,Ag)[Ag]("hide",e)}expand(e=true){babelHelpers.classPrivateFieldLooseBase(this,Ag)[Ag]("show",e)}toggle(e=true){babelHelpers.classPrivateFieldLooseBase(this,Ag)[Ag]("toggle",e)}getParagraphHeight(){if(babelHelpers.classPrivateFieldLooseBase(this,Cg)[Cg]!==null){return babelHelpers.classPrivateFieldLooseBase(this,Cg)[Cg]}const e=this.getThemeClasses().paragraph||"";const t=F.Tag.render(Gp||(Gp=zp`<p class="${0}"><br /></p>`),e);F.Dom.style(t,{position:"absolute",transform:"translateY(-1000px)"});F.Dom.append(t,this.getScrollerContainer());babelHelpers.classPrivateFieldLooseBase(this,Cg)[Cg]=t.offsetHeight+F.Text.toNumber(F.Dom.style(t,"margin-top"))+F.Text.toNumber(F.Dom.style(t,"margin-bottom"));F.Dom.remove(t);return babelHelpers.classPrivateFieldLooseBase(this,Cg)[Cg]}getLexicalEditor(){return babelHelpers.classPrivateFieldLooseBase(this,rg)[rg]}setRootElement(e){if(F.Type.isElementNode(e)||e===null){babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].setRootElement(e)}}getBBCodeExportMap(){return babelHelpers.classPrivateFieldLooseBase(this,ug)[ug]}getBBCodeImportMap(){return babelHelpers.classPrivateFieldLooseBase(this,bg)[bg]}getEditorState(){return babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].getEditorState()}getPlugins(){return babelHelpers.classPrivateFieldLooseBase(this,ng)[ng]}getPlugin(e){return babelHelpers.classPrivateFieldLooseBase(this,ng)[ng].get(e)}getElementByKey(e){return babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].getElementByKey(e)}setEditorState(e,t){babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].setEditorState(e,t)}setEditable(e){if(F.Type.isBoolean(e)){this.dispatchCommand(H);if(!e){this.blur()}babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].setEditable(e)}}isEditable(){return babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].isEditable()}registerUpdateListener(e){return babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].registerUpdateListener(e)}registerEditableListener(e){return babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].registerEditableListener(e)}registerCommand(e,t,s){return babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].registerCommand(e,t,s)}dispatchCommand(e,t){return babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].dispatchCommand(e,t)}registerMutationListener(e,t){return babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].registerMutationListener(e,t)}registerNodeTransform(e,t){return babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].registerNodeTransform(e,t)}registerTextContentListener(e){return babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].registerTextContentListener(e)}registerDecoratorListener(e){return babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].registerDecoratorListener(e)}registerRootListener(e){return babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].registerRootListener(e)}registerEventListener(e,t,s){const i=["mouseenter","mouseleave"].includes(t);const r=t=>{this.update((()=>{const r=L.$getNearestNodeFromDOMNode(t.target);if(r!==null){const a=i?r instanceof e?r:null:y.$findMatchingParent(r,(t=>t instanceof e));if(a!==null){s(t,a.getKey())}}}))};return this.registerRootListener(((e,s)=>{if(e){F.Event.bind(e,t,r,i)}if(s){F.Event.unbind(s,t,r,i)}}))}update(e,t){babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].update(e,t)}focus(e,t){if(!document.hasFocus()){window.focus()}babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].focus(F.Type.isFunction(e)?e:null,F.Type.isPlainObject(t)?t:{defaultSelection:"rootStart"})}hasFocus(){return this.getRootElement().contains(document.activeElement)}blur(){babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].blur()}isComposing(){return babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].isComposing()}getRootElement(){return babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].getRootElement()}hasNodes(e){return babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].hasNodes(e)}getRootContainer(){return babelHelpers.classPrivateFieldLooseBase(this,og)[og].remember("root",(()=>{const e=[this.isEditable()?"--editable":"--read-only"];return F.Tag.render(Vp||(Vp=zp`
				<div class="ui-text-editor ${0}">
					${0}
				</div>
			`),e.join(" "),this.getInnerContainer())}))}getInnerContainer(){return babelHelpers.classPrivateFieldLooseBase(this,og)[og].remember("inner",(()=>F.Tag.render(Jp||(Jp=zp`
			...
			`),this.getHeaderContainer(),this.getToolbarContainer(),this.getScrollerContainer(),this.getFooterContainer())))}getToolbarContainer(){return babelHelpers.classPrivateFieldLooseBase(this,og)[og].remember("toolbar",(()=>F.Tag.render(qp||(qp=zp`
				<div class="ui-text-editor-toolbar" tabindex="-1"></div>
			`))))}getScrollerContainer(){return babelHelpers.classPrivateFieldLooseBase(this,og)[og].remember("scroller",(()=>F.Tag.render(Qp||(Qp=zp`
				<div class="ui-text-editor-scroller">
					${0}
				</div>
			`),this.getEditableContainer())))}getEditableContainer(){return babelHelpers.classPrivateFieldLooseBase(this,og)[og].remember("editable",(()=>F.Tag.render(Zp||(Zp=zp`
				<div 
					class="ui-text-editor-editable" 
					contenteditable="${0}" 
					spellcheck="true"
				></div>
			`),this.isEditable()?"true":"false")))}getFooterContainer(){return babelHelpers.classPrivateFieldLooseBase(this,og)[og].remember("footer",(()=>F.Tag.render(eg||(eg=zp`
				<div class="ui-text-editor-slot ui-text-editor-footer" tabindex="-1"></div>
			`))))}getHeaderContainer(){return babelHelpers.classPrivateFieldLooseBase(this,og)[og].remember("header",(()=>F.Tag.render(tg||(tg=zp`
				<div class="ui-text-editor-slot ui-text-editor-header" tabindex="-1"></div>
			`))))}renderTo(e,t=false){if(!F.Type.isElementNode(e)){return}if(!this.isRendered()){if(F.Type.isStringFilled(babelHelpers.classPrivateFieldLooseBase(this,lg)[lg].get("content"))){this.setText(babelHelpers.classPrivateFieldLooseBase(this,lg)[lg].get("content"))}else{babelHelpers.classPrivateFieldLooseBase(this,_g)[_g](babelHelpers.classPrivateFieldLooseBase(this,lg)[lg].get("editorState"))}}if(t){F.Dom.replace(e,this.getRootContainer())}else{F.Dom.append(this.getRootContainer(),e)}babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].setRootElement(this.getEditableContainer());if(this.hasAutoFocus()){this.focus(null,{defaultSelection:"rootStart"})}if(!babelHelpers.classPrivateFieldLooseBase(this,Eg)[Eg]){babelHelpers.classPrivateFieldLooseBase(this,Og)[Og]=new ResizeObserver((()=>{this.emit("onResize");this.dispatchCommand(H,{context:"resize"})}));babelHelpers.classPrivateFieldLooseBase(this,Og)[Og].observe(this.getScrollerContainer())}babelHelpers.classPrivateFieldLooseBase(this,Eg)[Eg]=true}isRendered(){return babelHelpers.classPrivateFieldLooseBase(this,Eg)[Eg]}highlightSelection(){this.getEditorState().read((()=>{const e=L.$getSelection();if(!L.$isRangeSelection(e)||e.isCollapsed()){return}const t=e.anchor;const s=e.focus;const i=d.createDOMRange(babelHelpers.classPrivateFieldLooseBase(this,rg)[rg],t.getNode(),t.offset,s.getNode(),s.offset);if(i!==null){const e=this.getScrollerContainer();const t=e.getBoundingClientRect();const s=d.createRectsFromDOMRange(babelHelpers.classPrivateFieldLooseBase(this,rg)[rg],i);const r=s.length;babelHelpers.classPrivateFieldLooseBase(this,Pg)[Pg].innerHTML="";for(let i=0;i<r;i++){const r=s[i];const a=F.Tag.render(sg||(sg=zp`<span class="ui-text-editor-selection-part"></span>`));const o=r.top-t.top+e.scrollTop;const l=r.left-t.left+e.scrollLeft;F.Dom.style(a,{top:`${o}px`,left:`${l}px`,height:`${r.height}px`,width:`${r.width}px`});F.Dom.append(a,babelHelpers.classPrivateFieldLooseBase(this,Pg)[Pg])}F.Dom.append(babelHelpers.classPrivateFieldLooseBase(this,Pg)[Pg],this.getScrollerContainer())}}))}resetHighlightSelection(){F.Dom.remove(babelHelpers.classPrivateFieldLooseBase(this,Pg)[Pg])}destroy(){if(babelHelpers.classPrivateFieldLooseBase(this,Tg)[Tg]){return}babelHelpers.classPrivateFieldLooseBase(this,Tg)[Tg]=true;this.emit("onDestroy");for(const[,e]of babelHelpers.classPrivateFieldLooseBase(this,ng)[ng]){e.destroy()}babelHelpers.classPrivateFieldLooseBase(this,fg)[fg]();if(this.isRendered()){babelHelpers.classPrivateFieldLooseBase(this,Og)[Og].disconnect();this.setRootElement(null);F.Dom.remove(this.getRootContainer())}babelHelpers.classPrivateFieldLooseBase(this,Og)[Og]=null;babelHelpers.classPrivateFieldLooseBase(this,ng)[ng]=null;babelHelpers.classPrivateFieldLooseBase(this,rg)[rg]=null;this.$refs=null;babelHelpers.classPrivateFieldLooseBase(this,hg)[hg]=null;babelHelpers.classPrivateFieldLooseBase(this,bg)[bg]=null;babelHelpers.classPrivateFieldLooseBase(this,ug)[ug]=null;babelHelpers.classPrivateFieldLooseBase(this,gg)[gg]=null;babelHelpers.classPrivateFieldLooseBase(this,vg)[vg]=null;Object.setPrototypeOf(this,null)}}function jg(e,t){if(F.Type.isNil(e)){babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].update((()=>{const e=L.$getRoot();if(e.isEmpty()){const t=L.$createParagraphNode();e.append(t)}}),t)}else if(F.Type.isPlainObject(e)||F.Type.isStringFilled(e)){const t=babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].parseEditorState(e);babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].setEditorState(t)}else if(F.Type.isFunction(e)){babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].update((()=>{const t=L.$getRoot();if(t.isEmpty()){e(babelHelpers.classPrivateFieldLooseBase(this,rg)[rg])}}),t)}}function kg(e){const t=[];e.forEach((e=>{if(e.useDecoratorComponent){const s=this.registerMutationListener(e,((e,t)=>{for(const[t,s]of e){if(s==="destroyed"){const e=babelHelpers.classPrivateFieldLooseBase(this,vg)[vg].get(t);if(e){e.destroy()}babelHelpers.classPrivateFieldLooseBase(this,vg)[vg].delete(t)}else{babelHelpers.classPrivateFieldLooseBase(this,gg)[gg].add(t)}}}));t.push(s)}}));const s=babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].registerDecoratorListener((e=>{babelHelpers.classPrivateFieldLooseBase(this,gg)[gg].forEach((t=>{const s=e[t];const{componentClass:i,options:r}=s;const a=babelHelpers.classPrivateFieldLooseBase(this,vg)[vg].get(t);const o=babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].getElementByKey(t);if(o!=null&&o.innerHTML&&a){a.update(r)}else if(o){babelHelpers.classPrivateFieldLooseBase(this,vg)[vg].set(t,new i({textEditor:this,target:o,nodeKey:t,options:r}))}}));babelHelpers.classPrivateFieldLooseBase(this,gg)[gg].clear()}));t.push(s);return y.mergeRegister(...t)}function Ug(){return y.mergeRegister(this.registerCommand(L.FOCUS_COMMAND,(()=>{if(this.isCollapsingModeEnabled()&&babelHelpers.classPrivateFieldLooseBase(this,Hg)[Hg]===ig.COLLAPSED&&this.isEmpty(false)){this.expand();return true}this.emit("onFocus");return false}),L.COMMAND_PRIORITY_CRITICAL),this.registerCommand(L.BLUR_COMMAND,(e=>{if(this.isCollapsingModeEnabled()&&(babelHelpers.classPrivateFieldLooseBase(this,Hg)[Hg]===ig.COLLAPSING||babelHelpers.classPrivateFieldLooseBase(this,Hg)[Hg]===ig.EXPANDING)){return true}this.emit("onBlur");return false}),L.COMMAND_PRIORITY_CRITICAL),this.registerUpdateListener((({dirtyElements:e,dirtyLeaves:t,prevEditorState:s,tags:i})=>{const r=this.isComposing();const a=t.size>0||e.size>0;if(r||!a){return}const o=s.isEmpty();if(babelHelpers.classPrivateFieldLooseBase(this,lg)[lg].get("collapsingMode")===true){if(o){babelHelpers.classPrivateFieldLooseBase(this,wg)[wg]()}else if(this.isCollapsed()&&!this.isEmpty()){this.expand(false)}}if(!o&&i.has("history-merge")){return}this.emit("onChange",{isInitialChange:o,tags:i});const l=this.isEmpty();if(babelHelpers.classPrivateFieldLooseBase(this,Ng)[Ng]!==l){babelHelpers.classPrivateFieldLooseBase(this,Ng)[Ng]=l;this.emit("onEmptyContentToggle",{isEmpty:l,isInitialChange:o})}})),this.registerCommand(L.KEY_ENTER_COMMAND,(e=>{const{code:t,ctrlKey:s,metaKey:i}=e;if(F.Browser.isMac()&&i||s){this.emit("onMetaEnter");return true}if(t==="Escape"){this.emit("onEscape");return true}return false}),L.COMMAND_PRIORITY_LOW),this.registerEditableListener((e=>{this.getEditableContainer().contentEditable=e;if(e){F.Dom.removeClass(this.getRootContainer(),"--read-only");F.Dom.addClass(this.getRootContainer(),"--editable")}else{F.Dom.removeClass(this.getRootContainer(),"--editable");F.Dom.addClass(this.getRootContainer(),"--read-only")}this.emit("onEditable",{isEditable:e})})))}function Wg(e){const t=xn(e.map((e=>e.getName())).sort().join("-"));return String(t)}function Yg(){const e=new Map;for(const[,t]of babelHelpers.classPrivateFieldLooseBase(this,ng)[ng]){const s=t.importBBCode();if(s!==null){Object.keys(s).forEach((t=>{let i=e.get(t);if(i===undefined){i=[];e.set(t,i)}i.push(s[t])}))}}return e}function zg(){const e=new Map;for(const[,t]of babelHelpers.classPrivateFieldLooseBase(this,ng)[ng]){const s=t.exportBBCode();if(s!==null){Object.keys(s).forEach((t=>{if(F.Type.isFunction(s[t])){e.set(t,s[t])}}))}}return e}function Xg(){const e=this.getPlugin("File");const t=e!=null&&e.isEnabled()?e.getMode():"none";return new n.DefaultBBCodeScheme({fileTag:t})}function Gg(){babelHelpers.classPrivateFieldLooseBase(this,Fg)[Fg]=true;if(this.isEmpty()){babelHelpers.classPrivateFieldLooseBase(this,Ag)[Ag]("hide",false,true)}else{this.expand(false)}}function Vg(e="hide",t=true,s=false){if(!this.isCollapsingModeEnabled()){return}const i=babelHelpers.classPrivateFieldLooseBase(this,Hg)[Hg]===ig.COLLAPSED||babelHelpers.classPrivateFieldLooseBase(this,Hg)[Hg]===ig.COLLAPSING;const r=babelHelpers.classPrivateFieldLooseBase(this,Hg)[Hg]===ig.EXPANDED||babelHelpers.classPrivateFieldLooseBase(this,Hg)[Hg]===ig.EXPANDING;if(e==="hide"&&i||e==="show"&&r){return}if(t===false){if(i){babelHelpers.classPrivateFieldLooseBase(this,Hg)[Hg]=ig.EXPANDED;F.Dom.removeClass(this.getRootContainer(),"--collapsed");this.emit("onCollapsingToggle",{isOpen:true});this.focus()}else{babelHelpers.classPrivateFieldLooseBase(this,Hg)[Hg]=ig.COLLAPSED;F.Dom.addClass(this.getRootContainer(),"--collapsed");this.emit("onCollapsingToggle",{isOpen:false});this.clear();this.clearHistory();if(!s){this.blur()}}return}F.Event.unbind(this.getRootContainer(),"transitionend",babelHelpers.classPrivateFieldLooseBase(this,Bg)[Bg]);if(i){babelHelpers.classPrivateFieldLooseBase(this,Hg)[Hg]=ig.EXPANDING;this.blur();const e=this.getRootContainer().offsetHeight;F.Dom.removeClass(this.getRootContainer(),["--collapsed","--collapsing"]);F.Dom.style(this.getRootContainer(),{height:`${e}px`,overflow:"hidden"});F.Dom.style(this.getInnerContainer(),{opacity:0});requestAnimationFrame((()=>{F.Dom.addClass(this.getRootContainer(),"--expanding");F.Dom.style(this.getRootContainer(),{height:`${this.getRootContainer().scrollHeight}px`});F.Dom.style(this.getInnerContainer(),{opacity:1});this.emit("onCollapsingToggle",{isOpen:true})}))}else{babelHelpers.classPrivateFieldLooseBase(this,Hg)[Hg]=ig.COLLAPSING;const e=this.getRootContainer().offsetHeight;F.Dom.removeClass(this.getRootContainer(),["--expanding"]);F.Dom.style(this.getRootContainer(),{height:`${e}px`,overflow:"hidden"});F.Dom.style(this.getInnerContainer(),{opacity:1});this.blur();const t=this.getParagraphHeight();requestAnimationFrame((()=>{F.Dom.addClass(this.getRootContainer(),"--collapsing");F.Dom.style(this.getRootContainer(),{height:`${t}px`});F.Dom.style(this.getInnerContainer(),{opacity:0});this.emit("onCollapsingToggle",{isOpen:false})}))}F.Event.bind(this.getRootContainer(),"transitionend",babelHelpers.classPrivateFieldLooseBase(this,Bg)[Bg])}function Jg(){F.Event.unbind(this.getRootContainer(),"transitionend",babelHelpers.classPrivateFieldLooseBase(this,Bg)[Bg]);F.Dom.style(this.getRootContainer(),{height:null,overflow:null});F.Dom.style(this.getInnerContainer(),{opacity:null});F.Dom.removeClass(this.getRootContainer(),["--expanding","--collapsing"]);if(babelHelpers.classPrivateFieldLooseBase(this,Hg)[Hg]===ig.COLLAPSING){F.Dom.addClass(this.getRootContainer(),"--collapsed");babelHelpers.classPrivateFieldLooseBase(this,Hg)[Hg]=ig.COLLAPSED;this.clear();this.clearHistory();this.blur()}else{this.focus();babelHelpers.classPrivateFieldLooseBase(this,Hg)[Hg]=ig.EXPANDED}}const qg={name:"TextEditorComponent",props:{editorOptions:{type:Object},editorInstance:{type:Kg,default:null},events:{type:Object,default:{}},editable:{type:Boolean,default:null}},setup(){return{editorClass:Kg}},provide(){return{editor:this.editor}},beforeCreate(){if(this.editorInstance===null){this.hasOwnEditor=true;const e=this.editorClass;this.editor=new e(this.editorOptions)}else{this.hasOwnEditor=false;this.editor=this.editorInstance}if(F.Type.isPlainObject(this.events)){for(const[e,t]of Object.entries(this.events)){this.editor.subscribe(e,t)}}},computed:{headerContainer(){return this.editor.getHeaderContainer()},footerContainer(){return this.editor.getFooterContainer()}},watch:{editable(e){this.editor.setEditable(e)}},mounted(){this.editor.renderTo(this.$refs.container,true)},unmounted(){if(this.hasOwnEditor){this.editor.destroy();this.editor=null}},template:`\n\t\t<div ref="container"></div>\n\t\t<Teleport :to="headerContainer">\n\t\t\t<slot name="header"></slot>\n\t\t</Teleport>\n\t\t<Teleport :to="footerContainer">\n\t\t\t<slot name="footer"></slot>\n\t\t</Teleport>\n\t`};class Qg extends Kg{static getDefaultOptions(){return{plugins:["RichText","Paragraph","Clipboard","Bold","Underline","Italic","Strikethrough","TabIndent","List","Mention","Link","AutoLink","Image","Copilot","History","BlockToolbar","FloatingToolbar","Toolbar","Placeholder","File"],toolbar:["bold","italic","underline","strikethrough","|","numbered-list","bulleted-list","|","link","copilot"],newLineMode:N.MIXED}}}const Zg={name:"BasicEditorComponent",extends:qg,setup(){return{editorClass:Qg}}};const ev={Paragraph:Mt,AutoLink:th,BlockToolbar:Eu,Bold:dd,Code:Fs,FloatingToolbar:yp,History:$b,Image:xa,Italic:ud,Link:Dc,List:vh,Mention:Qo,Quote:Se,Strikethrough:md,TabIndent:oh,Toolbar:Np,Underline:Hd,Video:Pn,Spoiler:ut,Smiley:vl,Table:kh,Hashtag:Vh,File:Br,Copilot:Ib};const tv={...T};const sv={..._};const iv={generateContent:Sn};e.TextEditor=Kg;e.BasicEditor=Qg;e.TextEditorComponent=qg;e.BasicEditorComponent=Zg;e.BasePlugin=ie;e.Button=ge;e.Plugins=ev;e.Commands=tv;e.Constants=sv;e.Debug=iv})(this.BX.UI.TextEditor=this.BX.UI.TextEditor||{},BX.UI.CodeParser,BX.UI.BBCode,BX.UI.TextEditor,BX.UI.Lexical.Clipboard,BX.UI.Smiley,BX.UI.VideoService,BX.Collections,BX.UI.BBCode,BX.UI.Lexical.Selection,BX.UI.Lexical.RichText,BX.UI.Lexical.Table,BX.Event,BX.UI.Lexical.History,BX.Main,BX.Cache,BX,BX.UI.Lexical.List,BX.UI.Lexical.Link,BX.UI.Lexical.Text,BX.UI.Lexical.Core,BX.UI.Lexical.Utils,BX);
